...
public class FlowTaskVo {
     ...
     */
    @Transient()
    private List<FlowTaskInputsVo> inputList = new ArrayList<FlowTaskInputsVo>();

    /**
     * 输出
     */
    @Transient()
    private List<FlowTaskDeliverablesInfoVo> outputList = new ArrayList<FlowTaskDeliverablesInfoVo>();
     ...
     */
    @Transient()
    private List<FlowTaskResourceLinkInfoVo> resourceLinkList = new ArrayList<FlowTaskResourceLinkInfoVo>();
...
//    }
    ...
    public List<FlowTaskInputsVo> getInputList() {
        return inputList;
    }

    public void setInputList(List<FlowTaskInputsVo> inputList) {
        this.inputList = inputList;
    }

    public List<FlowTaskDeliverablesInfoVo> getOutputList() {
        return outputList;
    }

    public void setOutputList(List<FlowTaskDeliverablesInfoVo> outputList) {
    ...
    public List<FlowTaskResourceLinkInfoVo> getResourceLinkList() {
        return resourceLinkList;
    }

    public void setResourceLinkList(List<FlowTaskResourceLinkInfoVo> resourceLinkList) {
