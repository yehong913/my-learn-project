...
/*	gantt.attachEvent("onTaskOpened", function(t) {
		...
		var i = n.indexOf("?") >= 0 ? "&" : "?";
		alert(n + i + "parent_id=" + encodeURIComponent(t));
...
$(function() {
	...
	gantt.config.branch_loading = true;
	gantt.load("/lrds/app/gantt/getTaskGanttInfoAsync?parent_id=&oid=" + oid,function(){
		// 隐藏加载进度条
	...
	var dp = new dataProcessor("/lrds/app/gantt/getTaskGanttInfoAsync");
    dp.init(gantt);
    reloadRenderGantt();
