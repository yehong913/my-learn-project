function initToolbar() {
	...
	myToolbar.attachEvent("onclick", function(id) {
		...
		else if(id=="applyModifyPlanActivityFinishDate")
		{
			if (confirm("确定使调整后计划生效吗?")) {
				var result = postAction("applyModifyPlanActivityFinishDate", {'projectOid':projectOid}, true);
				if(result.success)
				{
...
$(function() {
	...
	gantt.config.branch_loading = true;
	gantt.load("/lrds/app/gantt/getEditTaskGanttInfoAsync?parent_id=&oid=" + oid,function(){
		// 隐藏加载进度条
	...
	var dp = new dataProcessor("/lrds/app/gantt/getEditTaskGanttInfoAsync");
    dp.init(gantt);
