...
<body>
    <input id="isPlanChange" name="isPlanChange" type="hidden" value="${isPlanChange}">
...
<script type="text/javascript">
	...
	function getLoadData() {
		var  datas;
        var isPlanChange = $('#isPlanChange').val();
		var id = $('#id').val();
		...
		$.ajax({
			url : 'resourceLinkInfoController.do?doUpdateResourceForPlan',
			async : false,
			cache : false,
			type : 'post',
			data : datas,
