...
<%--	<fd:lazydatagrid id="deliverablesList" idField="id" url="taskFlowResolveController.do?changeDeliverablesList&type=${type}&cellId=${cellId}&parentPlanId=${parentPlanId}"
	  toolbar="#documentListtbs" fit="true" fitColumns="true" style="height:500px;">
		<fd:columns>
	...
	<fd:datagrid checkbox="true" fitColumns="true"  checked="true" checkOnSelect="true" idField="id" toolbar="#documentListtbs" id="deliverablesList"  pagination="true"
				 url="taskFlowResolveController.do?changeDeliverablesList&type=${type}&cellId=${cellId}&parentPlanId=${parentPlanId}" fit="true">
...
<script type="text/javascript">
	...
	function searchDocument() {
	    ...
	    var  datas;
			...
			$.ajax({
				url : 'taskFlowResolveController.do?search4',
				async : false,
				cache : false,
				type : 'post',
				data : datas,
				...
				success : function(data) {
					...
					if (d.success) {
						...
						$.ajax({
							type : 'POST',
							url : 'taskFlowResolveController.do?datagridSearchlist4&cellId=${cellId}&parentPlanId=${parentPlanId}',
							async : false,
							data : datas,
							success : function(data) {
