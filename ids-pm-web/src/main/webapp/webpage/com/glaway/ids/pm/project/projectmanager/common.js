...
function processFunction(value) {
	if (value) {
        ...
        '<div style="width:' + value + '%;background:#92cd18;color:#000000;padding-left:4px;word-wrap: normal; word-break: initial;white-space: nowrap">' + value + '%' + '</div>'
        '</div>';
		return s;
	} else {
		var value1 = '0.00';
		var s1 = '<div style="width:100%;border:1px solid #dee5e7">' +
        '<div style="width:' + value1 + '%;background:#92cd18;color:#000000;padding-left:4px;word-wrap: normal; word-break: initial;white-space: nowrap">' + value1 + '%' + '</div>'
        '</div>';
		return s1;
	}
