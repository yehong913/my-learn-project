...
<div class="easyui-layout" fit="true">
    ...
    <div region="center" style="padding: 1px; width: 100%;height:100px;" title="" id="center_page_panel">
        <fd:toolbar>
    ...
    <div region="south" style="padding: 1px; height: 60px">
        <div class="div-msg-btn">
            <div class="ui_buttons">
                <fd:linkbutton id="backSubmit" onclick="backSaveAndSubmit()" value="{com.glaway.ids.common.lable.submit}" classStyle="button_nor" />
                <fd:linkbutton id="cancelBtn" onclick="closeTemplate()" value="{com.glaway.ids.common.btn.cancel}"  classStyle="ui_state_highlight lhgdialog_cancle" />
            </div>
        </div>
    </div>
</div>
