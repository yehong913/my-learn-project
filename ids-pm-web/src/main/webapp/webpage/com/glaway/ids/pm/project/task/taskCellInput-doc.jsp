...
<script type="text/javascript">
	function afterSubmitDocResolve(data,file,response) {
...
<body style="overflow-y: hidden; padding: 10px 0px 0px 0px;" scroll="no">
	<fd:uploadify name="files" id="file_upload" title="{com.glaway.ids.common.lable.uploadAttachment}"
		uploader="taskFlowResolveController.do?addFileAttachments&ids=${ids}&templateId=${templateId}&cellId=${cellId}&useObjectId=${inputs_.useObjectId}&type=LOCAL"
		extend="*.*;" auto="false" showPanel="false" dialog="false" multi="true"
		formData="documentTitle" >
		<fd:eventListener event="onUploadSuccess" listener="afterSubmitDocResolve" />
	</fd:uploadify>
</body>
</html>
