...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#deliver_list_select_to')
				.datalist(
						{
							url : 'taskFlowResolveController.do?doCellRelationSearch&side=right&parentPlanId=${parentPlanId}&fromCellId=${fromCellId}&toCellId=${toCellId}',
							//title : '输出交付项',
							textField : 'name',
							valueField : 'name',
							idField : 'id',
		...
		$('#deliver_list_select_from')
				.datalist(
						{
							url : 'taskFlowResolveController.do?doCellRelationSearch&side=left&parentPlanId=${parentPlanId}&fromCellId=${fromCellId}&toCellId=${toCellId}',
							//title : '输入交付项',
							textField : 'name',
							valueField : 'name',
							idField : 'id',
	...
	function confirmSelections() {
		...
		$.post(
				"${pageContext.request.contextPath }/taskFlowResolveController.do?doCellRelationChange",
				{
					'names' : names.join(','),
					'ids' : ids.join(','),
