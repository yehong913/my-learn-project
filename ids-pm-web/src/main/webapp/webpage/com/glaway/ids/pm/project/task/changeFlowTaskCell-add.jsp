...
<script type="text/javascript" src="webpage/com/glaway/changeFlowTask/changeFlowTask.js"></script>
...
<body>
	<fd:tabs id="tt" tabPosition="top" fit="true">
		<fd:tab title="{com.glaway.ids.pm.project.plan.nodeinfo}" id="baseInfo"
			href="applyFlowResolveForChangeController.do?goChangeTab&tabIndex=0&cellId=${cellId}&parentPlanId=${parentPlanId}&isEnableFlag=${isEnableFlag}&refDuration=${refDuration}&enterType=${enterType}"></fd:tab>
		<%-- <fd:tab title="{com.glaway.ids.pm.project.plan.input}" id="cellInput"
			href="taskFlowResolveController.do?goChangeTab&tabIndex=2&cellId=${cellId}&parentPlanId=${parentPlanId}&isEnableFlag=${isEnableFlag}"></fd:tab>
		<fd:tab title="{com.glaway.ids.pm.project.plan.reference}" id="cellReference"
			href="taskFlowResolveController.do?goChangeTab&tabIndex=3&cellId=${cellId}&parentPlanId=${parentPlanId}&isEnableFlag=${isEnableFlag}"></fd:tab>
		<fd:tab title="{com.glaway.ids.pm.project.plan.output}" id="cellOutput"
			href="taskFlowResolveController.do?goChangeTab&tabIndex=4&cellId=${cellId}&parentPlanId=${parentPlanId}&isEnableFlag=${isEnableFlag}"></fd:tab>
		<fd:tab title="{com.glaway.ids.pm.project.plan.resource}" id="cellResource"
			href="taskFlowResolveController.do?goChangeTab&tabIndex=5&cellId=${cellId}&parentPlanId=${parentPlanId}&isEnableFlag=${isEnableFlag}"></fd:tab> --%>
	</fd:tabs>
</body>
<script type="text/javascript">
