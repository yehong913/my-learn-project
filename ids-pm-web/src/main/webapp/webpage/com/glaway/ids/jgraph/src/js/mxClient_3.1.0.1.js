...
if (mxClient.IS_VML) if (mxClient.IS_SVG) mxClient.IS_VML = !1;
else {
...
var mxLog = {
    ...
    enter: function(a) {
        if (mxLog.TRACE) return mxLog.writeln("Entering " + a),
        (new Date).getTime()
    },
    leave: function(a, b) {
        if (mxLog.TRACE) {
...
var mxEffects = {
        ...
        e = function() {
            ...
            k = 0; k < b.length; k++) {
                ...
                if (l instanceof mxGeometryChange || l instanceof mxTerminalChange || l instanceof mxValueChange || l instanceof mxChildChange || l instanceof mxStyleChange) {
                    ...
                    if (null != m) if (g = !0, l.constructor != mxGeometryChange || a.model.isEdge(l.cell)) mxUtils.setOpacity(m.shape.node, 100 * d / 10);
                    else {
    ...
    cascadeOpacity: function(a, b, c) {
        ...
        if (null != b) for (e = 0; e < b.length; e++) d = a.getView().getState(b[e]),
...
mxUtils = {
    ...
    removeCursors: function(a) {
        ...
        a = a.childNodes;
        if (null != a) for (var b = a.length,
        c = 0; c < b; c += 1) mxUtils.removeCursors(a[c])
    },
    ...
    findNodeByAttribute: function() {
        ...
        function(a, b, c) {
            var d = null;
            if (null != a) if (a.nodeType == mxConstants.NODETYPE_ELEMENT && a.getAttribute(b) == c) d = a;
            else for (a = a.firstChild; null != a && null == d;) d = mxUtils.findNodeByAttribute(a, b, c),
            a = a.nextSibling;
            return d
        }: mxClient.IS_IE ?
        function(a, b, c) {
    ...
    remove: function(a, b) {
        var c = null;
        if ("object" == typeof b) for (var d = mxUtils.indexOf(b, a); 0 <= d;) b.splice(d, 1),
        c = a,
    ...
    getChildNodes: function(a, b) {
        ...
        for (var c = [], d = a.firstChild; null != d;) d.nodeType == b && c.push(d),
        d = d.nextSibling;
        return c
    },
    importNode: function(a, b, c) {
        ...
        case 1:
            ...
            if (b.attributes && 0 < b.attributes.length) {
                ...
                if (c && b.childNodes && 0 < b.childNodes.length) for (e = 0; e < b.childNodes.length; e++) d.appendChild(mxUtils.importNode(a, b.childNodes[e], c))
            }
            return d;
        case 3:
        case 4:
    ...
    getPrettyXml: function(a, b, c) {
        var d = [];
        if (null != a) if (b = b || "  ", c = c || "", a.nodeType == mxConstants.NODETYPE_TEXT) d.push(a.nodeValue);
        else {
            d.push(c + "<" + a.nodeName);
            var e = a.attributes;
            ...
            e = a.firstChild;
            if (null != e) {
                for (d.push(">\n"); null != e;) d.push(mxUtils.getPrettyXml(e, b, c + b)),
                e = e.nextSibling;
                d.push(c + "</" + a.nodeName + ">\n")
            } else d.push("/>\n")
        }
    ...
    br: function(a, b) {
        b = b || 1;
        for (var c = null,
        d = 0; d < b; d++) null != a && (c = a.ownerDocument.createElement("br"), a.appendChild(c));
        return c
    },
    ...
    clone: function(a, b, c) {
        ...
        if (null != a && "function" == typeof a.constructor) {
            ...
            e;
            for (e in a) if (e != mxObjectIdentity.FIELD_NAME && (null == b || 0 > mxUtils.indexOf(b, e))) d[e] = !c && "object" == typeof a[e] ? mxUtils.clone(a[e]) : a[e]
        }
        return d
    },
    ...
    equalEntries: function(a, b) {
        if (null == a && null != b || null != a && null == b || null != a && null != b && a.length != b.length) return ! 1;
        if (null != a && null != b) for (var c in a) if ((!mxUtils.isNaN(a[c]) || !mxUtils.isNaN(b[c])) && a[c] != b[c]) return ! 1;
        return ! 0
    },
    isNaN: function(a) {
    ...
    getOffset: function(a, b) {
        ...
        c = c + e.x,
        d = d + e.y;
        for (; a.offsetParent;) c += a.offsetLeft,
        d += a.offsetTop,
        a = a.offsetParent;
    ...
    getScrollOrigin: function(a) {
        for (var b = document.body,
        c = document.documentElement,
        d = mxUtils.getDocumentScrollOrigin(null != a ? a.ownerDocument: document); null != a && a != b && a != c;) ! isNaN(a.scrollLeft) && !isNaN(a.scrollTop) && (d.x += a.scrollLeft, d.y += a.scrollTop),
        a = a.parentNode;
        return d
    },
    ...
    setStyleFlag: function(a, b, c, d) {
        if (null == a || 0 == a.length) a = d || null == d ? b + "=" + c: b + "=0";
            ...
            var e = a.indexOf(b + "=");
            if (0 > e) e = ";" == a.charAt(a.length - 1) ? "": ";",
            a = d || null == d ? a + e + b + "=" + c: a + e + b + "=0";
            else {
                var f = a.indexOf(";", e),
                g = "",
    ...
    show: function(a, b, c, d, e, f) {
        ...
        if (mxClient.IS_IE || 11 == document.documentMode) {
            ...
            for (d = null; null != f;) g = f.cloneNode(!0),
    ...
    error: function(a, b, c, d) {
        ...
        c && (mxUtils.br(e), b = document.createElement("p"), c = document.createElement("button"), mxClient.IS_IE ? c.style.cssText = "float:right": c.setAttribute("style", "float:right"), mxEvent.addListener(c, "click",
        function(a) {
            g.destroy()
...
mxMouseEvent.prototype.consume = function(a) { (null != a ? a: 1) && this.evt.preventDefault && this.evt.preventDefault();
...
mxEventSource.prototype.fireEvent = function(a, b) {
    if (null != this.eventListeners && this.isEventsEnabled()) {
        ...
        for (var c = [b, a], d = 0; d < this.eventListeners.length; d += 2) {
            var e = this.eventListeners[d]; (null == e || e == a.getName()) && this.eventListeners[d + 1].apply(this, c)
        }
    }
};
var mxEvent = {
    ...
    removeListener: function() {
        var a = function(a, c, d) {
            if (null != a.mxListenerList) {
                ...
                for (var e = 0; e < c; e++) if (a.mxListenerList[e].f == d) {
                    a.mxListenerList.splice(e, 1);
                    break
                }
                0 == a.mxListenerList.length && (a.mxListenerList = null, a = mxUtils.indexOf(mxEvent.objects, a), 0 <= a && mxEvent.objects.splice(a, 1))
            }
        };
    ...
    addGestureListeners: function(a, b, c, d) {
        ...
        null != d && mxEvent.addListener(a, mxClient.IS_POINTER ? "MSPointerUp": "mouseup", d); ! mxClient.IS_POINTER && mxClient.IS_TOUCH && (null != b && mxEvent.addListener(a, "touchstart", b), null != c && mxEvent.addListener(a, "touchmove", c), null != d && mxEvent.addListener(a, "touchend", d))
    },
    removeGestureListeners: function(a, b, c, d) {
        ...
        null != d && mxEvent.removeListener(a, mxClient.IS_POINTER ? "MSPointerUp": "mouseup", d); ! mxClient.IS_POINTER && mxClient.IS_TOUCH && (null != b && mxEvent.removeListener(a, "touchstart", b), null != c && mxEvent.removeListener(a, "touchmove", c), null != d && mxEvent.removeListener(a, "touchend", d))
    },
    redirectMouseEvents: function(a, b, c, d, e, f, g) {
        var k = function(a) {
            return "function" == typeof c ? c(a) : c
        };
        mxEvent.addGestureListeners(a,
        function(a) {
        ...
        mxEvent.addListener(a, "dblclick",
        function(a) {
            if (null != g) g(a);
    ...
    release: function(a) {
        if (null != a && (mxEvent.removeAllListeners(a), a = a.childNodes, null != a)) for (var b = a.length,
        c = 0; c < b; c += 1) mxEvent.release(a[c])
    },
    ...
    disableContextMenu: function() {
        return mxClient.IS_IE && ("undefined" === typeof document.documentMode || 9 > document.documentMode) ?
        function(a) {
    ...
    isMiddleMouseButton: function(a) {
        return a.button == (mxClient.IS_IE && ("undefined" === typeof document.documentMode || 9 > document.documentMode) ? 4 : 1)
    },
    ...
    getMainEvent: function(a) { ("touchstart" == a.type || "touchmove" == a.type) && null != a.touches && null != a.touches[0] ? a = a.touches[0] : "touchend" == a.type && (null != a.changedTouches && null != a.changedTouches[0]) && (a = a.changedTouches[0]);
        return a
    },
...
mxXmlRequest.prototype.send = function(a, b) {
    ...
    null != this.request && (null != a && (this.request.onreadystatechange = mxUtils.bind(this,
    function() {
...
var mxClipboard = {
    ...
    paste: function(a) {
        if (!mxClipboard.isEmpty()) {
            var b = a.getImportableCells(mxClipboard.getCells()),
...
mxWindow.prototype.installMinimizeHandler = function() {
    ...
    function(d) {
        ...
        mxClient.IS_QUIRKS || (this.div.style.height = c),
    ...
    function(f) {
        ...
        if ("none" != this.maximize.style.display) {
            if (a) {
                ...
                if (!mxClient.IS_QUIRKS && (this.div.style.height = d, this.div.style.width = e, k = mxUtils.getCurrentStyle(this.contentWrapper), "auto" == k.overflow || null != this.resize)) this.contentWrapper.style.height = this.div.offsetHeight - this.title.offsetHeight - this.contentHeightCorrection + "px";
...
mxWindow.prototype.installMoveHandler = function() {
    ...
    mxEvent.addGestureListeners(this.title, mxUtils.bind(this,
    function(a) {
...
mxWindow.prototype.installCloseHandler = function() {
    ...
    mxEvent.addGestureListeners(this.closeImg, mxUtils.bind(this,
    function(a) {
...
function mxDivResizer(a, b) {
    if ("div" == a.nodeName.toLowerCase()) {
        ...
        mxEvent.addListener(b, "resize", mxUtils.bind(this,
        function(a) {
...
function mxDragSource(a, b) {
    this.element = a;
    this.dropHandler = b;
    mxEvent.addGestureListeners(a, mxUtils.bind(this,
    function(a) {
        this.mouseDown(a)
    }));
    this.eventConsumer = function(a, b) {
        var e = b.getProperty("eventName"),
        f = b.getProperty("event");
        e != mxEvent.MOUSE_DOWN && f.consume()
    }
}
...
mxToolbar.prototype.addItem = function(a, b, c, d, e, f) {
    ...
    mxEvent.addGestureListeners(g, mxUtils.bind(this,
    function(a) {
...
mxToolbar.prototype.addSwitchMode = function(a, b, c, d, e) {
    ...
    mxEvent.addListener(f, "click", mxUtils.bind(this,
    function(a) {
...
mxToolbar.prototype.addMode = function(a, b, c, d, e, f) {
    ...
    this.enabled && f && (mxEvent.addListener(g, "click", mxUtils.bind(this,
    function(a) {
        this.selectMode(g, c);
        this.noReset = !1
    })), mxEvent.addListener(g, "dblclick", mxUtils.bind(this,
    function(a) {
        this.selectMode(g, c);
        this.noReset = !0
...
mxToolbar.prototype.resetMode = function(a) { (a || !this.noReset) && this.selectedMode != this.defaultMode && this.selectMode(this.defaultMode, this.defaultFunction)
};
...
function mxSession(a, b, c, d) {
    ...
    a.addListener(mxEvent.NOTIFY, mxUtils.bind(this,
    function(a, b) {
        var c = b.getProperty("edit"); (null != c && this.debug || this.connected && !this.suspended) && this.notify("<edit>" + this.encodeChanges(c.changes, c.undone) + "</edit>")
    }))
}
...
mxSession.prototype.start = function() {
    this.debug ? (this.connected = !0, this.fireEvent(new mxEventObject(mxEvent.CONNECT))) : this.connected || this.get(this.urlInit, mxUtils.bind(this,
    function(a) {
        this.connected = !0;
...
mxSession.prototype.poll = function() {
    this.connected && !this.suspended && null != this.urlPoll ? (this.polling = !0, this.get(this.urlPoll, mxUtils.bind(this,
    function() {
        this.poll()
    }))) : this.polling = !1
};
...
mxSession.prototype.get = function(a, b, c) {
    if ("undefined" != typeof mxUtils) {
        ...
        mxUtils.get(a, mxUtils.bind(this,
        function(c) {
...
mxSession.prototype.encodeChanges = function(a, b) {
    for (var c = "",
    d = b ? -1 : 1, e = b ? a.length - 1 : 0; 0 <= e && e < a.length; e += d) var f = this.codec.encode(a[e]),
...
mxSession.prototype.processState = function(a) { (new mxCodec(a.ownerDocument)).decode(a.firstChild, this.model)
};
...
function mxPanningManager(a) {
    ...
    mxEvent.addListener(document, "mouseup", mxUtils.bind(this,
    function() {
        this.active && this.stop()
    }));
    ...
    this.stop = function() {
        if (this.active) if (this.active = !1, null != this.thread && (window.clearInterval(this.thread), this.thread = null), this.tdy = this.tdx = 0, this.scrollbars) a.panDx = 0,
        a.panDy = 0,
        a.fireEvent(new mxEventObject(mxEvent.PAN));
        else {
            var b = a.panDx,
            d = a.panDy;
            if (0 != b || 0 != d) a.panGraph(0, 0),
            a.view.setTranslate(this.t0x + b / a.view.scale, this.t0y + d / a.view.scale)
        }
    };
...
mxPopupMenu.prototype.addItem = function(a, b, c, d, e, f) {
    ...
    null != b ? (e = document.createElement("img"), e.src = b, k.appendChild(e)) : null != e && (mxClient.IS_QUIRKS || 8 == document.documentMode ? (b = document.createElement("a"), b.setAttribute("href", "#")) : b = document.createElement("div"), b.className = e, k.appendChild(b));
    g.appendChild(k);
    ...
    if (null == f || f) mxEvent.addGestureListeners(g, mxUtils.bind(this,
    function(a) {
    ...
    mxEvent.addListener(g, "mouseout", mxUtils.bind(this,
    function(a) {
        g.className = "mxPopupMenuItem"
    }));
    return g
...
mxPopupMenu.prototype.popup = function(a, b, c, d) {
    if (null != this.div && null != this.tbody && null != this.factoryMethod) {
        this.div.style.left = a + "px";
        for (this.div.style.top = b + "px"; null != this.tbody.firstChild;) mxEvent.release(this.tbody.firstChild),
...
mxImageExport.prototype.drawState = function(a, b) {
    null != a && (this.visitStatesRecursive(a, b, mxUtils.bind(this,
    function() {
        this.drawCellState.apply(this, arguments)
    })), this.includeOverlays && this.visitStatesRecursive(a, b, mxUtils.bind(this,
    function() {
...
mxImageExport.prototype.visitStatesRecursive = function(a, b, c) {
    if (null != a) {
        c(a, b);
        for (var d = a.view.graph,
        e = d.model.getChildCount(a.cell), f = 0; f < e; f++) {
...
mxAbstractCanvas2D.prototype.addOp = function() {
    if (null != this.path && (this.path.push(arguments[0]), 2 < arguments.length)) for (var a = this.state,
    b = 2; b < arguments.length; b += 2) this.lastX = arguments[b - 1],
...
mxXmlCanvas2D.prototype.rotate = function(a, b, c, d, e) {
    ...
    if (0 != a || b || c) f.setAttribute("theta", this.format(a)),
    f.setAttribute("flipH", b ? "1": "0"),
    f.setAttribute("flipV", c ? "1": "0"),
    f.setAttribute("cx", this.format(d)),
    f.setAttribute("cy", this.format(e)),
...
mxSvgCanvas2D.prototype.getSvgGradient = function(a, b, c, d, e) {
    ...
    if (null == g) {
        ...
        l = 0,
        m = f + "-" + l;
        if (null != k) for (g = k.ownerDocument.getElementById(m); null != g && g.ownerSVGElement != k;) m = f + "-" + l++,
        g = k.ownerDocument.getElementById(m);
...
mxSvgCanvas2D.prototype.updateFill = function() {
    ...
    null != a.fillColor && (null != a.gradientColor ? (a = this.getSvgGradient(a.fillColor, a.gradientColor, a.fillAlpha, a.gradientAlpha, a.gradientDirection), !mxClient.IS_IE && this.root.ownerDocument == document ? this.node.setAttribute("fill", "url(" + this.getBaseUrl() + "#" + a + ")") : this.node.setAttribute("fill", "url(#" + a + ")")) : this.node.setAttribute("fill", a.fillColor.toLowerCase()))
};
...
mxSvgCanvas2D.prototype.createDiv = function(a, b, c, d, e) {
    ...
    d = "display:inline-block;font-size:" + Math.round(f.fontSize) + "px;font-family:" + f.fontFamily + ";color:" + f.fontColor + ";line-height:" + c + ";" + d; (f.fontStyle & mxConstants.FONT_BOLD) == mxConstants.FONT_BOLD && (d += "font-weight:bold;"); (f.fontStyle & mxConstants.FONT_ITALIC) == mxConstants.FONT_ITALIC && (d += "font-style:italic;"); (f.fontStyle & mxConstants.FONT_UNDERLINE) == mxConstants.FONT_UNDERLINE && (d += "text-decoration:underline;");
    c = "";
    ...
    mxUtils.isNode(a) || (b = document.createElement("textarea"), b.innerHTML = a.replace(/&lt;/g, "&amp;lt;").replace(/&gt;/g, "&amp;gt;").replace(/</g, "&lt;").replace(/>/g, "&gt;"), a = b.value, "fill" != e && "width" != e ? a = '<div xmlns="http://www.w3.org/1999/xhtml" style="display:inline-block;text-align:inherit;text-decoration:inherit;' + c + '">' + a + "</div>": d += c);
    if (!mxClient.IS_IE && !mxClient.IS_IE11 && document.createElementNS) return e = document.createElementNS("http://www.w3.org/1999/xhtml", "div"),
    e.setAttribute("style", d),
    mxUtils.isNode(a) ? this.root.ownerDocument != document ? e.appendChild(a.cloneNode(!0)) : e.appendChild(a) : e.innerHTML = a,
    e;
        ...
        if (this.foEnabled && "html" == l) {
            ...
            if (null != r) {
                ...
                if (mxClient.IS_IE && (9 == document.documentMode || !mxClient.IS_SVG)) {
                    ...
                    } else u = z.offsetWidth + x,
                    x = z.offsetHeight + y;
                    v.parentNode.removeChild(v);
                    t.appendChild(r)
                } else this.root.ownerDocument != document || mxClient.IS_FF ? (r.style.visibility = "hidden", document.body.appendChild(r)) : t.appendChild(r),
                v = r,
                null != v.firstChild && "DIV" == v.firstChild.nodeName && (v = v.firstChild),
                u = v.offsetWidth,
                !n && (k && 0 < c && this.root.ownerDocument != document) && (A = r.style.whiteSpace, r.style.whiteSpace = "nowrap", u == v.offsetWidth && (x += this.fontMetricsPadding), r.style.whiteSpace = A),
                u += x,
                k && (n && (u = Math.min(u, c)), r.style.width = u + "px"),
                u = v.offsetWidth + x,
                x = v.offsetHeight + 2,
                r.parentNode != t && (t.appendChild(r), r.style.visibility = "");
                n && (x = Math.min(x, d));
                ...
                a += r;
                g == mxConstants.ALIGN_MIDDLE ? x -= d / 2 - 1 : g == mxConstants.ALIGN_BOTTOM && (x -= d - 2);
                b += x;
...
mxSvgCanvas2D.prototype.createClip = function(a, b, c, d) {
    ...
    c = Math.round(c);
    d = Math.round(d);
    for (var e = "mx-clip-" + a + "-" + b + "-" + c + "-" + d,
    f = 0,
    g = e + "-" + f; null != document.getElementById(g);) g = e + "-" + ++f;
...
mxSvgCanvas2D.prototype.plainText = function(a, b, c, d, e, f, g, k, l, m, n) {
    ...
    if (m && 0 < c && 0 < d) {
        ...
        null != this.defs ? this.defs.appendChild(n) : this.root.appendChild(n); ! mxClient.IS_IE && this.root.ownerDocument == document ? q.setAttribute("clip-path", "url(" + this.getBaseUrl() + "#" + n.getAttribute("id") + ")") : q.setAttribute("clip-path", "url(#" + n.getAttribute("id") + ")")
    }
    n = f == mxConstants.ALIGN_RIGHT ? "end": f == mxConstants.ALIGN_CENTER ? "middle": "start";
    "start" != n && q.setAttribute("text-anchor", n); (!this.styleEnabled || p != mxConstants.DEFAULT_FONTSIZE) && q.setAttribute("font-size", Math.round(p * k.scale) + "px");
    ...
    for (m = 0; m < r.length; m++) 0 < r[m].length && 0 < mxUtils.trim(r[m]).length && (p = this.createElement("text"), p.setAttribute("x", this.format(a * k.scale)), p.setAttribute("y", this.format(n * k.scale)), mxUtils.write(p, r[m]), q.appendChild(p)),
    n += s;
    this.root.appendChild(q);
...
mxSvgCanvas2D.prototype.updateFont = function(a) {
    var b = this.state;
    a.setAttribute("fill", b.fontColor); (!this.styleEnabled || b.fontFamily != mxConstants.DEFAULT_FONTFAMILY) && a.setAttribute("font-family", b.fontFamily); (b.fontStyle & mxConstants.FONT_BOLD) == mxConstants.FONT_BOLD && a.setAttribute("font-weight", "bold"); (b.fontStyle & mxConstants.FONT_ITALIC) == mxConstants.FONT_ITALIC && a.setAttribute("font-style", "italic"); (b.fontStyle & mxConstants.FONT_UNDERLINE) == mxConstants.FONT_UNDERLINE && a.setAttribute("text-decoration", "underline")
};
mxSvgCanvas2D.prototype.addTextBackground = function(a, b, c, d, e, f, g, k, l) {
    var m = this.state;
    if (null != m.fontBackgroundColor || null != m.fontBorderColor) {
        var n = null;
        if ("fill" == l || "width" == l) g == mxConstants.ALIGN_CENTER ? c -= e / 2 : g == mxConstants.ALIGN_RIGHT && (c -= e),
        k == mxConstants.ALIGN_MIDDLE ? d -= f / 2 : k == mxConstants.ALIGN_BOTTOM && (d -= f),
        n = new mxRectangle((c + 1) * m.scale, d * m.scale, (e - 2) * m.scale, (f + 2) * m.scale);
        ...
        } catch(q) {} else n = document.createElement("div"),
        n.style.lineHeight = mxConstants.ABSOLUTE_LINE_HEIGHT ? Math.round(m.fontSize * mxConstants.LINE_HEIGHT) + "px": mxConstants.LINE_HEIGHT,
        n.style.fontSize = Math.round(m.fontSize) + "px",
        n.style.fontFamily = m.fontFamily,
        n.style.whiteSpace = "nowrap",
        n.style.position = "absolute",
        n.style.visibility = "hidden",
        n.style.display = mxClient.IS_QUIRKS ? "inline": "inline-block",
        n.style.zoom = "1",
        (m.fontStyle & mxConstants.FONT_BOLD) == mxConstants.FONT_BOLD && (n.style.fontWeight = "bold"),
        (m.fontStyle & mxConstants.FONT_ITALIC) == mxConstants.FONT_ITALIC && (n.style.fontStyle = "italic"),
        b = mxUtils.htmlEntities(b, !1),
        n.innerHTML = b.replace(/\n/g, "<br/>"),
        ...
        k == mxConstants.ALIGN_MIDDLE ? d -= f / 2 : k == mxConstants.ALIGN_BOTTOM && (d -= f),
        n = new mxRectangle((c + 1) * m.scale, (d + 2) * m.scale, e * m.scale, (f + 1) * m.scale);
...
mxVmlCanvas2D.prototype.addNode = function(a, b) {
    ...
    d = this.state;
    if (null != c) {
        if ("shape" == c.nodeName) if (null != this.path && 0 < this.path.length) c.path = this.path.join(" ") + " e",
...
mxVmlCanvas2D.prototype.createDiv = function(a, b, c, d) {
    ...
    mxUtils.isNode(a) ? c.appendChild(a) : "fill" != d && "width" != d ? (d = this.createElement("div"), d.style.cssText = f, d.style.display = mxClient.IS_QUIRKS ? "inline": "inline-block", d.style.zoom = "1", d.style.textDecoration = "inherit", d.innerHTML = a, c.appendChild(d)) : (c.style.cssText = f, c.innerHTML = a);
    a = c.style;
    ...
    a.verticalAlign = "top";
    a.textAlign = b || "left";
    a.lineHeight = mxConstants.ABSOLUTE_LINE_HEIGHT ? Math.round(e.fontSize * mxConstants.LINE_HEIGHT / this.vmlScale) + "px": mxConstants.LINE_HEIGHT; (e.fontStyle & mxConstants.FONT_BOLD) == mxConstants.FONT_BOLD && (a.fontWeight = "bold"); (e.fontStyle & mxConstants.FONT_ITALIC) == mxConstants.FONT_ITALIC && (a.fontStyle = "italic"); (e.fontStyle & mxConstants.FONT_UNDERLINE) == mxConstants.FONT_UNDERLINE && (a.textDecoration = "underline");
    return c
};
mxVmlCanvas2D.prototype.text = function(a, b, c, d, e, f, g, k, l, m, n, p) {
    if (this.textEnabled && null != e) {
        ...
        if ("html" == l) {
            ...
            n ? (e.style.overflow = "hidden", e.style.width = Math.round(c) + "px", mxClient.IS_QUIRKS || (e.style.maxHeight = Math.round(d) + "px")) : "fill" == m ? (e.style.width = c + "px", e.style.height = d + "px") : "width" == m && (e.style.width = c + "px", 0 < d && (e.style.maxHeight = Math.round(d) + "px"));
            if (this.rotateHtml && 0 != p) {
                ...
                if (mxClient.IS_QUIRKS && (n || "width" == m) && y > d) y = d,
                e.style.height = y + "px";
                d = y;
                ...
                e.style.position = "";
                e.style.visibility = ""
            } else 8 != document.documentMode ? (e.style.verticalAlign = "top", 1 > this.state.alpha && (l.style.filter = "alpha(opacity=" + 100 * this.state.alpha + ")"), q = e.parentNode, e.style.visibility = "hidden", document.body.appendChild(e), c = e.offsetWidth, y = e.offsetHeight, mxClient.IS_QUIRKS && (n && y > d) && (y = d, e.style.height = y + "px"), d = y, e.style.visibility = "", q.appendChild(e), l.style.left = this.format(a + c * t * this.state.scale) + "px", l.style.top = this.format(b + d * s * this.state.scale) + "px") : (1 > this.state.alpha && (e.style.filter = "alpha(opacity=" + 100 * this.state.alpha + ")"), r.style.left = 100 * t + "%", r.style.top = 100 * s + "%")
...
mxVmlCanvas2D.prototype.plainText = function(a, b, c, d, e, f, g, k, l, m, n, p) {
    ...
    d.style.fontSize = f + "px"; (k.fontStyle & mxConstants.FONT_BOLD) == mxConstants.FONT_BOLD && (d.style.fontWeight = "bold"); (k.fontStyle & mxConstants.FONT_ITALIC) == mxConstants.FONT_ITALIC && (d.style.fontStyle = "italic"); (k.fontStyle & mxConstants.FONT_UNDERLINE) == mxConstants.FONT_UNDERLINE && (d.style.textDecoration = "underline");
    e = e.split("\n");
...
mxGuide.prototype.move = function(a, b, c) {
    if (null != this.states && (this.horizontal || this.vertical) && null != a && null != b) {
        ...
        } ! k && null != this.guideX ? this.guideX.node.style.visibility = "hidden": null != this.guideX && (this.guideX.node.style.visibility = "visible", this.guideX.redraw()); ! l && null != this.guideY ? this.guideY.node.style.visibility = "hidden": null != this.guideY && (this.guideY.node.style.visibility = "visible", this.guideY.redraw());
...
mxStencil.prototype.drawChildren = function(a, b, c, d, e, f, g, k) {
    if (null != g && 0 < e && 0 < f) {
        ...
        a.setStrokeWidth(d);
        for (g = g.firstChild; null != g;) g.nodeType == mxConstants.NODETYPE_ELEMENT && this.drawNode(a, b, g, c, k),
        g = g.nextSibling
    }
};
...
mxStencil.prototype.drawNode = function(a, b, c, d, e) {
    ...
    if ("save" == f) a.save();
        ...
        a.begin();
        for (c = c.firstChild; null != c;) c.nodeType == mxConstants.NODETYPE_ELEMENT && this.drawNode(a, b, c, d, e),
        c = c.nextSibling
    ...
    else if ("roundrect" == f) b = Number(c.getAttribute("arcsize")),
    0 == b && (b = 100 * mxConstants.RECTANGLE_ROUNDING_FACTOR),
    n = Number(c.getAttribute("w")) * l,
    d = Number(c.getAttribute("h")) * m,
    b = Number(b) / 100,
    b = Math.min(n * b, d * b),
    a.roundrect(g + Number(c.getAttribute("x")) * l, k + Number(c.getAttribute("y")) * m, n, d, b, b);
    ...
    else if ("image" == f) b = this.evaluateAttribute(c, "src", b),
    a.image(g + Number(c.getAttribute("x")) * l, k + Number(c.getAttribute("y")) * m, Number(c.getAttribute("w")) * l, Number(c.getAttribute("h")) * m, b, !1, "1" == c.getAttribute("flipH"), "1" == c.getAttribute("flipV"));
    else if ("text" == f) {
    ...
    else if ("strokewidth" == f) l = "1" == c.getAttribute("fixed") ? 1 : n,
    a.setStrokeWidth(Number(c.getAttribute("width")) * l);
...
mxShape.prototype.clear = function() {
    ...
    else this.node.style.cssText = "position:absolute;",
    this.node.innerHTML = ""
};
...
mxShape.prototype.createCanvas = function() {
    ...
    this.outline && (a.setStrokeWidth(this.strokewidth), a.setStrokeColor(this.stroke), null != this.isDashed && a.setDashed(this.isDashed), a.setStrokeWidth = function() {},
...
mxShape.prototype.paint = function(a) {
    ...
    if (null == this.stencil && null == this.points && this.shapePointerEvents || null != this.stencil && this.stencilPointerEvents) {
        ...
        this.dialect == mxConstants.DIALECT_SVG ? (g = this.createTransparentSvgRectangle(k.x, k.y, k.width, k.height), this.node.appendChild(g)) : (k = a.createRect("rect", k.x / b, k.y / b, k.width / b, k.height / b), k.appendChild(a.createTransparentFill()), k.stroked = "false", a.root.appendChild(k))
    }
...
mxShape.prototype.apply = function(a) {
    ...
    if (null != this.style) {
        ...
        if (this.direction == mxConstants.DIRECTION_NORTH || this.direction == mxConstants.DIRECTION_SOUTH) a = this.flipH,
...
mxMarker = {
    ...
    mxMarker.addMarker("open",
    function(a, b, e, f, g, k, l, m, n, p) {
        b = 1.118 * g * n;
        e = 1.118 * k * n;
        g *= l + n;
        k *= l + n;
...
mxPolyline.prototype.paintLine = function(a, b, c) {
    ...
    for (var g = 1; g < b.length - 1; g++) {
        ...
        if (c && g < b.length - 1 && (0 != l || 0 != e)) {
            ...
            for (e = b[g + 1]; g < b.length - 2 && 0 == Math.round(e.x - k.x) && 0 == Math.round(e.y - k.y);) e = b[g + 2],
            g++;
            l = e.x - k.x;
            e = e.y - k.y;
...
mxText.prototype.apply = function(a) {
    ...
    null != this.style && (this.fontStyle = mxUtils.getValue(this.style, mxConstants.STYLE_FONTSTYLE, this.fontStyle), this.family = mxUtils.getValue(this.style, mxConstants.STYLE_FONTFAMILY, this.family), this.size = mxUtils.getValue(this.style, mxConstants.STYLE_FONTSIZE, this.size), this.color = mxUtils.getValue(this.style, mxConstants.STYLE_FONTCOLOR, this.color), this.align = mxUtils.getValue(this.style, mxConstants.STYLE_ALIGN, this.align), this.valign = mxUtils.getValue(this.style, mxConstants.STYLE_VERTICAL_ALIGN, this.valign), this.spacingTop = mxUtils.getValue(this.style, mxConstants.STYLE_SPACING_TOP, this.spacingTop), this.spacingRight = mxUtils.getValue(this.style, mxConstants.STYLE_SPACING_RIGHT, this.spacingRight), this.spacingBottom = mxUtils.getValue(this.style, mxConstants.STYLE_SPACING_BOTTOM, this.spacingBottom), this.spacingLeft = mxUtils.getValue(this.style, mxConstants.STYLE_SPACING_LEFT, this.spacingLeft), this.horizontal = mxUtils.getValue(this.style, mxConstants.STYLE_HORIZONTAL, this.horizontal), this.background = mxUtils.getValue(this.style, mxConstants.STYLE_LABEL_BACKGROUNDCOLOR, this.background), this.border = mxUtils.getValue(this.style, mxConstants.STYLE_LABEL_BORDERCOLOR, this.border), this.updateMargin())
};
mxText.prototype.updateBoundingBox = function() {
    ...
    if (!this.ignoreStringSize && null != a && "fill" != this.overflow && (!this.clipped || !this.ignoreClippedStringSize || c != mxConstants.ALIGN_CENTER || d != mxConstants.ALIGN_MIDDLE)) {
        ...
        c = parseInt(a.getAttribute("width")) * this.scale,
    ...
    null != this.boundingBox && 0 != b && (b = mxUtils.getBoundingBox(this.boundingBox, b), this.boundingBox.x = b.x, this.boundingBox.y = b.y, mxClient.IS_QUIRKS || (this.boundingBox.width = b.width, this.boundingBox.height = b.height))
};
...
mxText.prototype.paint = function(a) {
    ...
    k = this.value; ! f && "html" == g && (k = mxUtils.htmlEntities(k, !1));
...
mxText.prototype.updateHtmlFilter = function() {
    ...
    if (null != g) {
        ...
        k = g;
        null != k.firstChild && "DIV" == k.firstChild.nodeName && (k = k.firstChild); ! this.clipped && (this.wrap && 0 < l) && (e = k.offsetWidth + this.textWidthPadding, g.style.width = e + "px");
        f = k.offsetHeight + 2;
...
mxText.prototype.updateValue = function() {
    ...
    this.node.appendChild(this.value);
        ...
        if ("fill" == this.overflow || "width" == this.overflow) null != b && (this.node.style.backgroundColor = b),
        null != c && (this.node.style.border = "1px solid " + c);
        else {
            var d = "";
...
mxImageShape.prototype.paintVertexShape = function(a, b, c, d, e) {
    if (null != this.image) {
        ...
        if (null != f || null != g) a.setFillColor(f),
        a.setStrokeColor(g),
        a.rect(b, c, d, e),
        a.fillAndStroke();
...
mxCylinder.prototype.redrawPath = function(a, b, c, d, e, f) {
    ...
    if (f && null != this.fill || !f && null == this.fill) a.moveTo(0, b),
...
mxConnector.prototype.createMarker = function(a, b, c) {
    ...
    if (null != f && null != g && null != k) {
        for (d = 1; d < e - 1 && 0 == Math.round(g.x - k.x) && 0 == Math.round(g.y - k.y);) g = c ? b[1 + d] : b[e - 2 - d],
        d++;
        b = k.x - g.x;
        e = k.y - g.y;
        ...
        d = mxMarker.createMarker(a, this, f, k, g, b, e, c, this.arrowStrokewidth, 0 != this.style[c ? mxConstants.STYLE_STARTFILL: mxConstants.STYLE_ENDFILL])
    }
    return d
};
...
mxSwimlane.prototype.getLabelBounds = function(a) {
    ...
    e = c && e != (this.direction == mxConstants.DIRECTION_SOUTH || this.direction == mxConstants.DIRECTION_WEST);
    if (f) {
...
mxSwimlane.prototype.getGradientBounds = function(a, b, c, d, e) {
    a = this.getTitleSize();
    if (this.isHorizontal()) return a = Math.min(a, e),
...
mxSwimlane.prototype.paintSwimlane = function(a, b, c, d, e, f, g, k) {
    ...
    a.begin();
    this.isHorizontal() ? (a.moveTo(0, f), a.lineTo(0, 0), a.lineTo(d, 0), a.lineTo(d, f), k && a.close(), a.fillAndStroke(), f < e && g == mxConstants.NONE && (a.pointerEvents = !1, a.begin(), a.moveTo(0, f), a.lineTo(0, e), a.lineTo(d, e), a.lineTo(d, f), a.stroke())) : (a.moveTo(f, 0), a.lineTo(0, 0), a.lineTo(0, e), a.lineTo(f, e), k && a.close(), a.fillAndStroke(), f < d && g == mxConstants.NONE && (a.pointerEvents = !1, a.begin(), a.moveTo(f, 0), a.lineTo(d, 0), a.lineTo(d, e), a.lineTo(f, e), a.stroke()))
};
mxSwimlane.prototype.paintRoundedSwimlane = function(a, b, c, d, e, f, g, k, l) {
    ...
    a.begin();
    this.isHorizontal() ? (a.moveTo(d, f), a.lineTo(d, g), a.quadTo(d, 0, d - Math.min(d / 2, g), 0), a.lineTo(Math.min(d / 2, g), 0), a.quadTo(0, 0, 0, g), a.lineTo(0, f), l && a.close(), a.fillAndStroke(), f < e && k == mxConstants.NONE && (a.pointerEvents = !1, a.begin(), a.moveTo(0, f), a.lineTo(0, e - g), a.quadTo(0, e, Math.min(d / 2, g), e), a.lineTo(d - Math.min(d / 2, g), e), a.quadTo(d, e, d, e - g), a.lineTo(d, f), a.stroke())) : (a.moveTo(f, 0), a.lineTo(g, 0), a.quadTo(0, 0, 0, Math.min(e / 2, g)), a.lineTo(0, e - Math.min(e / 2, g)), a.quadTo(0, e, g, e), a.lineTo(f, e), l && a.close(), a.fillAndStroke(), f < d && k == mxConstants.NONE && (a.pointerEvents = !1, a.begin(), a.moveTo(f, e), a.lineTo(d - g, e), a.quadTo(d, e, d, e - Math.min(e / 2, g)), a.lineTo(d, Math.min(e / 2, g)), a.quadTo(d, 0, d - g, 0), a.lineTo(f, 0), a.stroke()))
};
...
mxGraphLayout.traverse = function(a, b, c, d, e) {
    if (null != c && null != a) {
        ...
        if (null == e[f] && (e[f] = a, d = c(a, d), null == d || d)) if (d = this.graph.model.getEdgeCount(a), 0 < d) for (f = 0; f < d; f++) {
            ...
            if (!b || k) k = this.graph.view.getVisibleTerminal(g, !k),
            this.traverse(k, b, c, g, e)
        }
    }
};
...
mxGraphLayout.prototype.setEdgePoints = function(a, b) {
    if (null != a) {
        ...
        if (null != this.parent && null != b) for (var e = c.getParent(a), e = this.getParentOffset(e), f = 0; f < b.length; f++) b[f].x -= e.x,
        b[f].y -= e.y;
        d.points = b;
        c.setGeometry(a, d)
    }
...
mxStackLayout.prototype.execute = function(a) {
    if (null != a) {
        ...
        try {
            ...
            k = null,
            m = 0,
            n = d.getChildCount(a), p = 0; p < n; p++) {
                var q = d.getChildAt(a, p);
                if (!this.isVertexIgnored(q) && this.isVertexMovable(q)) {
                    var r = d.getGeometry(q);
                    if (null != r) {
                        r = r.clone();
                        if (null != this.wrap && null != k && (c && k.x + k.width + r.width + 2 * this.spacing > this.wrap || !c && k.y + k.height + r.height + 2 * this.spacing > this.wrap)) k = null,
                        c ? g += l + this.spacing: f += l + this.spacing,
                        l = 0;
...
mxPartitionLayout.prototype.execute = function(a) {
    ...
    if (null != d) {
        for (var e = [], f = c.getChildCount(a), g = 0; g < f; g++) {
            var k = c.getChildAt(a, g); ! this.isVertexIgnored(k) && this.isVertexMovable(k) && e.push(k)
        }
        f = e.length;
        if (0 < f) {
            var l = this.border,
...
mxCompactTreeLayout.prototype.execute = function(a, b) {
    ...
    if (null != this.root) {
        ...
        try {
            if (this.visited = {},
            this.node = this.dfs(this.root, a), this.alignRanks && (this.maxRankHeight = [], this.findRankHeights(this.node, 0), this.setCellHeights(this.node, 0)), null != this.node) {
                ...
                if (null != g) {
                    ...
                    0 > g.y && (k = Math.abs(d - g.y)); (0 != e || 0 != k) && this.moveNode(this.node, e, k);
...
mxCompactTreeLayout.prototype.moveNode = function(a, b, c) {
    ...
    a.y += c;
    this.apply(a);
    for (a = a.child; null != a;) this.moveNode(a, b, c),
    a = a.next
};
...
mxCompactTreeLayout.prototype.findRankHeights = function(a, b) {
    ...
    for (var c = a.child; null != c;) this.findRankHeights(c, b + 1),
    c = c.next
};
mxCompactTreeLayout.prototype.setCellHeights = function(a, b) {
    ...
    for (var c = a.child; null != c;) this.setCellHeights(c, b + 1),
    c = c.next
};
...
mxCompactTreeLayout.prototype.layout = function(a) {
    if (null != a) {
        for (var b = a.child; null != b;) this.layout(b),
        b = b.next;
...
mxCompactTreeLayout.prototype.verticalLayout = function(a, b, c, d, e) {
    ...
    if (null != b) {
        ...
        c = a.x + b.offsetY;
        for (d = b.next; null != d;) e = this.verticalLayout(d, a, c, a.y + b.offsetX, e),
        c += d.offsetY,
        d = d.next
    }
    return e
...
mxCompactTreeLayout.prototype.localEdgeProcessing = function(a) {
    ...
    for (a = a.child; null != a;) this.localEdgeProcessing(a),
    a = a.next
};
mxCompactTreeLayout.prototype.processNodeOutgoing = function(a) {
    ...
    for (var f = this.minEdgeJetty - this.prefVertEdgeOff,
    g = 0,
    k = this.getVertexBounds(c), l = 0; l < e.length; l++) {
        for (var m = e[l].cell.cell, n = this.getVertexBounds(m), m = this.graph.getEdgesBetween(c, m, !1), p = [], q = 0, r = 0, s = 0; s < m.length; s++) this.horizontal ? (q = k.x + k.width, r = k.y + b, p.push(new mxPoint(q, r)), q = k.x + k.width + f, p.push(new mxPoint(q, r)), r = n.y + n.height / 2) : (q = k.x + b, r = k.y + k.height, p.push(new mxPoint(q, r)), r = k.y + k.height + f, p.push(new mxPoint(q, r)), q = n.x + n.width / 2),
        p.push(new mxPoint(q, r)),
        this.setEdgePoints(m[s], p);
...
mxRadialTreeLayout.prototype.execute = function(a, b) {
    ...
    for (var g = 0,
    k = 0,
    c = 0; c < this.row.length; c++) e = (this.rowMaxX[c] - this.centerX - this.nodeDistance) / this.rowRadi[c],
    ...
    for (c = 0; c < this.row.length; c++) {
        ...
        for (e = 0; e < this.row[c].length; e++) f = this.row[c],
        d = f[e],
        f = this.getVertexBounds(d.cell),
        d.theta = 2 * Math.PI * ((f.x + f.width / 2 - l) / m)
    }
    ...
    for (c = 0; c < this.row.length; c++) for (e = 0; e < this.row[c].length; e++) f = this.row[c],
    d = f[e],
    f = this.getVertexBounds(d.cell),
    this.setVertexLocation(d.cell, this.centerX - f.width / 2 + this.rowRadi[c] * Math.cos(d.theta), this.centerY - f.height / 2 + this.rowRadi[c] * Math.sin(d.theta))
};
mxRadialTreeLayout.prototype.calcRowDims = function(a, b) {
    if (! (null == a || 0 == a.length)) {
        ...
        this.row[b] = [];
        for (var c = !1,
        d = 0; d < a.length; d++) for (var e = a[d].child; null != e;) vertexBounds = this.getVertexBounds(e.cell),
        this.rowMinX[b] = Math.min(vertexBounds.x, this.rowMinX[b]),
        this.rowMaxX[b] = Math.max(vertexBounds.x + vertexBounds.width, this.rowMaxX[b]),
        this.rowMinCenX[b] = Math.min(vertexBounds.x + vertexBounds.width / 2, this.rowMinCenX[b]),
        this.rowMaxCenX[b] = Math.max(vertexBounds.x + vertexBounds.width / 2, this.rowMaxCenX[b]),
        this.rowRadi[b] = vertexBounds.y - this.getVertexBounds(this.root).y,
        null != e.child && (c = !0),
        this.row[b].push(e),
        e = e.next;
...
mxFastOrganicLayout.prototype.execute = function(a) {
    ...
    try {
        ...
        a = c = null;
        for (d = 0; d < this.vertexArray.length; d++) g = this.vertexArray[d],
        this.isVertexMovable(g) && (l = this.getVertexBounds(g), null != l && (this.cellLocation[d][0] -= l.width / 2, this.cellLocation[d][1] -= l.height / 2, p = this.graph.snap(this.cellLocation[d][0]), q = this.graph.snap(this.cellLocation[d][1]), this.setVertexLocation(g, p, q), c = null == c ? p: Math.min(c, p), a = null == a ? q: Math.min(a, q)));
        d = -(c || 0) + 1;
        g = -(a || 0) + 1;
        null != e && (d += e.x, g += e.y);
...
mxFastOrganicLayout.prototype.calcRepulsion = function() {
    for (var a = this.vertexArray.length,
    b = 0; b < a; b++) for (var c = b; c < a; c++) {
        if (!this.allowedToRun) return;
...
mxCircleLayout.prototype.execute = function(a) {
    ...
    try {
        ...
        d = null,
        e = null,
        f = [], g = b.getChildCount(a), k = 0; k < g; k++) {
...
mxCircleLayout.prototype.circle = function(a, b, c, d) {
    for (var e = a.length,
    f = 2 * Math.PI / e,
    g = 0; g < e; g++) this.isVertexMovable(a[g]) && this.setVertexLocation(a[g], c + b + b * Math.sin(g * f), d + b + b * Math.cos(g * f))
};
...
mxParallelEdgeLayout.prototype.layout = function(a) {
    ...
    if (e == d) for (var b = e.x + e.width + this.spacing,
    c = e.y + e.height / 2,
    f = 0; f < a.length; f++) this.route(a[f], b, c),
    b += this.spacing;
        ...
        if (0 < d) {
            ...
            for (f = 0; f < a.length; f++) this.route(a[f], b, c),
            b -= e,
            c += d
        }
    }
...
mxEdgeLabelLayout.prototype.execute = function(a) {
    for (var b = this.graph.view,
    c = this.graph.getModel(), d = [], e = [], f = c.getChildCount(a), g = 0; g < f; g++) {
        ...
        for (var g = 0; g < f.length; g++) {
            ...
            if (k != b[e] && a.graph.model.isVertex(k) && !a.isVertexIgnored(k)) {
                ...
                if (null != l && 0 < l.length && null == this.edgeMapper.get(l[0]) && 2 * k.length >= l.length) {
                    for (var k = new mxGraphHierarchyEdge(l), m = 0; m < l.length; m++) {
                        var n = l[m];
...
mxGraphHierarchyModel.prototype.initialRank = function() {
    ...
    for (var e = a.slice(); 0 < a.length;) {
        ...
        b = 0; b < f.length; b++) {
            var m = f[b];
            if (5270620 == m.temp[0]) m = m.source,
            l = Math.min(l, m.temp[0] - 1);
            else {
                k = !1;
                break
            }
        ...
        if (k) {
            ...
            if (null != g) for (b = 0; b < g.length; b++) m = g[b],
            m.temp[0] = 5270620,
            m = m.target,
            -1 == m.temp[0] && (a.push(m), m.temp[0] = -2);
            a.shift()
    ...
    for (b = 0; b < e.length; b++) {
        ...
        for (d = 0; d < f.length; d++) m = f[d],
        m = m.target,
        c.temp[0] = Math.max(a, m.temp[0] + 1),
        a = c.temp[0]
    }
...
mxGraphHierarchyModel.prototype.fixRanks = function() {
    var a = [];
    this.ranks = [];
    for (var b = 0; b < this.maxRank + 1; b++) a[b] = [],
    this.ranks[b] = a[b];
    var c = null;
    if (null != this.roots) for (var d = this.roots,
    c = [], b = 0; b < d.length; b++) {
    ...
    this.visit(function(b, c, d, e, m) {
        ...
        if (null != b && null != d && 1 < b.maxRank - c.maxRank) {
            ...
            d.x = [];
            d.y = [];
            for (b = d.minRank + 1; b < d.maxRank; b++) a[b].push(d),
...
mxGraphHierarchyModel.prototype.extendedDfs = function(a, b, c, d, e, f, g, k) {
    if (null != b) {
        if (null != a && (null == b.hashCode || b.hashCode[0] != a.hashCode[0])) f = a.hashCode.length + 1,
        ...
        if (null == e[g]) {
            ...
            a = b.connectsAsSource.slice();
            for (c = 0; c < a.length; c++) g = a[c],
            this.extendedDfs(b, g.target, g, d, e, b.hashCode, c, k + 1)
        } else d(a, b, c, k, 1)
    }
};
...
mxSwimlaneModel.prototype.initialRank = function() {
    ...
    d = [];
    b = [];
    for (c = this.ranksPerGroup.length - 1; 0 <= c; c--) d[c] = c == this.ranksPerGroup.length - 1 ? 0 : b[c + 1] + 1,
    b[c] = d[c] + this.ranksPerGroup[c];
    this.maxRank = b[0];
    for (var e in this.vertexMapper) d = this.vertexMapper[e],
    d.temp[0] = -1;
    for (a.slice(); 0 < a.length;) {
        ...
        for (var g = !0,
        k = b[0], c = 0; c < e.length; c++) {
            var l = e[c];
            if (5270620 == l.temp[0]) l = l.source,
            k = Math.min(k, l.temp[0] - 1);
            else {
                g = !1;
                break
            }
        ...
        if (g) {
            ...
            d.temp[0] = k;
            if (null != f) for (c = 0; c < f.length; c++) l = f[c],
            l.temp[0] = 5270620,
            l = l.target,
            -1 == l.temp[0] && (a.push(l), l.temp[0] = -2);
            a.shift()
...
mxMedianHybridCrossingReduction.prototype.execute = function(a) {
    ...
    for (var c = 0,
    d = this.calculateCrossings(a), b = 0; b < this.maxIterations && c < this.maxNoImprovementIterations; b++) {
        ...
        if (e < d) {
            ...
            for (e = 0; e < this.nestedBestRanks.length; e++) {
                ...
                k.setGeneralPurposeVariable(e, g)
            }
        }
        if (0 == d) break
    }
...
mxMedianHybridCrossingReduction.prototype.calculateCrossings = function(a) {
    for (var b = a.ranks.length,
    c = 0,
    d = 1; d < b; d++) c += this.calculateRankCrossing(d, a);
    return c
};
mxMedianHybridCrossingReduction.prototype.calculateRankCrossing = function(a, b) {
    for (var c = 0,
    d = b.ranks[a], e = b.ranks[a - 1], f = [], g = 0; g < d.length; g++) {
...
mxMedianHybridCrossingReduction.prototype.transpose = function(a, b) {
    for (var c = !0,
    d = 0; c && 10 > d++;) for (var e = 1 == a % 2 && 1 == d % 2,
    c = !1,
    f = 0; f < b.ranks.length; f++) {
        ...
        l = 0; l < g.length - 1; l++) {
            ...
            for (var z = 0,
            B = 0,
            v = 0; v < r.length; v++) for (var A = 0; A < t.length; A++) r[v] > t[A] && z++,
            r[v] < t[A] && B++;
            for (v = 0; v < s.length; v++) for (A = 0; A < u.length; A++) s[v] > u[A] && z++,
            s[v] < u[A] && B++;
            if (B < z || B == z && e) p = x.getGeneralPurposeVariable(f),
            x.setGeneralPurposeVariable(f, y.getGeneralPurposeVariable(f)),
            y.setGeneralPurposeVariable(f, p),
            p = m,
            q = n,
            t = r,
            u = s,
...
mxMinimumCycleRemover.prototype.execute = function(a) {
    a = this.layout.getModel();
    for (var b = {},
    c = a.vertexMapper.getValues(), d = {},
    e = 0; e < c.length; e++) d[c[e].id] = c[e];
    c = null;
    if (null != a.roots) for (var f = a.roots,
    c = [], e = 0; e < f.length; e++) c[e] = a.vertexMapper.get(f[e]);
...
mxCoordinateAssignment.prototype.minNode = function(a) {
    ...
    for (f = 0; 0 < b.length && f <= a;) {
        ...
        if (p) {
            for (e = 0; e < k.length; e++) l = k[e],
            l = c.get(l),
            null != l && !1 == l.visited && (l.visited = !0, b.push(l));
...
mxCoordinateAssignment.prototype.rankCoordinates = function(a, b, c) {
    ...
    for (var d = this.initialX + (this.widestRankValue - this.rankWidths[a]) / 2, e = !1, f = 0; f < b.length; f++) {
        ...
        } else g.isEdge() && (k = 1, null != g.edges ? k = g.edges.length: mxLog.warn("edge.edges is null"), g.width = (k - 1) * this.parallelEdgeSpacing);
        d += g.width / 2;
        g.setX(a, d);
...
mxCoordinateAssignment.prototype.calculateWidestRank = function(a, b) {
    ...
    for (var e = b.maxRank; 0 <= e; e--) {
        for (var f = 0,
        g = b.ranks[e], k = this.initialX, l = !1, m = 0; m < g.length; m++) {
            var n = g[m];
            if (n.isVertex()) {
            ...
            } else n.isEdge() && (p = 1, null != n.edges ? p = n.edges.length: mxLog.warn("edge.edges is null"), n.width = (p - 1) * this.parallelEdgeSpacing);
            k += n.width / 2;
            n.setX(e, k);
        ...
        d = f;
        c = this.orientation == mxConstants.DIRECTION_NORTH || this.orientation == mxConstants.DIRECTION_WEST ? c + k: c - k;
...
mxCoordinateAssignment.prototype.minPath = function(a, b) {
    for (var c = b.edgeMapper.getValues(), d = 0; d < c.length; d++) {
        ...
        if (! (1 > e.maxRank - e.minRank - 1)) {
            ...
            if (!g) {
                for (var g = f = 0,
                m = [], n = [], p = e.getGeneralPurposeVariable(e.minRank + 1), l = e.minRank + 1; l < e.maxRank - 1; l++) {
                    var q = e.getX(l + 1);
                    p == q ? (m[l - e.minRank - 1] = p, f++) : this.repositionValid(b, e, l + 1, p) ? (m[l - e.minRank - 1] = p, f++) : p = m[l - e.minRank - 1] = q
                }
                p = e.getX(l);
                for (l = e.maxRank - 1; l > e.minRank + 1; l--) q = e.getX(l - 1),
                p == q ? (n[l - e.minRank - 2] = p, g++) : this.repositionValid(b, e, l - 1, p) ? (n[l - e.minRank - 2] = p, g++) : (n[l - e.minRank - 2] = e.getX(l - 1), p = q);
...
mxCoordinateAssignment.prototype.setCellLocations = function(a, b) {
    this.rankTopY = [];
    this.rankBottomY = [];
    for (var c = 0; c < b.ranks.length; c++) this.rankTopY[c] = Number.MAX_VALUE,
    ...
    this.layout.resizeParent && null != d && this.adjustParents(d); (this.edgeStyle == mxHierarchicalEdgeStyle.ORTHOGONAL || this.edgeStyle == mxHierarchicalEdgeStyle.POLYLINE || this.edgeStyle == mxHierarchicalEdgeStyle.CURVE) && this.localEdgeProcessing(b);
            ...
            if ( - 1 < g && g < a.ranks.length && null != f && 0 < f.length) {
                ...
                for (var n = e.x[0] - e.width / 2, p = n + e.width, q = f = 0, g = [], m = 0; m < l.length; m++) {
                    ...
                    if (r.isVertex()) {
                        ...
                        for (var t = 0; t < s.length; t++) if (s[t].source == r || s[t].target == r) f += s[t].edges.length,
                        q++,
                        g.push(s[t])
                    } else f += r.edges.length,
                    q++,
                    g.push(r)
                }
...
mxCoordinateAssignment.prototype.setEdgePosition = function(a) {
    ...
    if (101207 != a.temp[0]) {
        ...
        for (var e = 0,
        f = this.jettyPositions[a.ids[0]], g = a.isReversed ? a.target.cell: a.source.cell, k = this.layout.graph, l = 0; l < a.edges.length; l++) {
            var m = a.edges[l],
...
mxSwimlaneOrdering.prototype.execute = function(a) {
    ...
    c = null;
    if (null != a.roots) for (var d = a.roots,
    c = [], e = 0; e < d.length; e++) {
    ...
    a.visit(function(a, c, d, e, f) {
        ...
        e ? (d.invert(), mxUtils.remove(d, a.connectsAsSource), c.connectsAsSource.push(d), a.connectsAsTarget.push(d), mxUtils.remove(d, c.connectsAsTarget)) : f && (d.invert(), mxUtils.remove(d, a.connectsAsTarget), c.connectsAsTarget.push(d), a.connectsAsSource.push(d), mxUtils.remove(d, c.connectsAsSource));
...
mxHierarchicalLayout.prototype.execute = function(a, b) {
    ...
    if (! (null == b && null == a)) {
        if (null != b) {
            for (var d = [], e = 0; e < b.length; e++)(null != a ? c.isAncestor(a, b[e]) : 1) && c.isVertex(b[e]) && d.push(b[e]);
            this.roots = d
        }
        c.beginUpdate();
        try {
...
mxHierarchicalLayout.prototype.getEdges = function(a) {
    ...
    b = [], d = this.graph.isCellCollapsed(a), e = c.getChildCount(a), f = 0; f < e; f++) {
    ...
    c = [];
    for (f = 0; f < b.length; f++) d = this.getVisibleTerminal(b[f], !0),
    e = this.getVisibleTerminal(b[f], !1),
    (d == e || d != e && (e == a && (null == this.parent || this.graph.isValidAncestor(d, this.parent, this.traverseAncestors)) || d == a && (null == this.parent || this.graph.isValidAncestor(e, this.parent, this.traverseAncestors)))) && c.push(b[f]);
...
mxHierarchicalLayout.prototype.run = function(a) {
    ...
    } else for (e = 0; e < this.roots.length; e++) k = {},
    b.push(k),
    this.traverse(this.roots[e], !0, null, c, k, b, null);
...
mxHierarchicalLayout.prototype.getEdgesBetween = function(a, b, c) {
    ...
    for (var d = this.getEdges(a), e = [], f = 0; f < d.length; f++) {
        ...
        k = this.getVisibleTerminal(d[f], !1); (g == a && k == b || !c && g == b && k == a) && e.push(d[f])
    }
    return e
};
...
mxHierarchicalLayout.prototype.cycleStage = function(a) { (new mxMinimumCycleRemover(this)).execute(a)
};
mxHierarchicalLayout.prototype.layeringStage = function() {
    this.model.initialRank();
    this.model.fixRanks()
};
mxHierarchicalLayout.prototype.crossingStage = function(a) { (new mxMedianHybridCrossingReduction(this)).execute(a)
};
...
mxSwimlaneLayout.prototype.execute = function(a, b) {
    ...
    if (! (null == b || 1 > b.length)) {
        ...
        for (var d = 0; d < b.length; d++) {
            ...
            if (null == e || 0 == e.length) e = this.graph.insertVertex(b[d], null, null, 0, 0, this.dummyVertexWidth, 0),
            this.dummyVertices.push(e)
        }
        c.beginUpdate();
        try {
            this.run(a),
            this.resizeParent && !this.graph.isCellCollapsed(a) && this.updateGroupBounds(),
...
mxSwimlaneLayout.prototype.getEdges = function(a) {
    ...
    for (var c = this.graph.model,
    d = [], e = this.graph.isCellCollapsed(a), f = c.getChildCount(a), g = 0; g < f; g++) {
        var k = c.getChildAt(a, g);
    ...
    c = [];
    for (g = 0; g < d.length; g++) e = this.getVisibleTerminal(d[g], !0),
    f = this.getVisibleTerminal(d[g], !1),
    (e == f || e != f && (f == a && (null == this.parent || this.graph.isValidAncestor(e, this.parent, this.traverseAncestors)) || e == a && (null == this.parent || this.graph.isValidAncestor(f, this.parent, this.traverseAncestors)))) && c.push(d[g]);
...
mxSwimlaneLayout.prototype.run = function(a) {
    ...
    if (null != this.swimlanes && 0 < this.swimlanes.length && null != a) {
        for (var d = {},
        e = 0; e < this.swimlanes.length; e++) this.filterDescendants(this.swimlanes[e], d);
        this.roots = [];
        var e = !0,
        f;
        for (f in d) if (null != d[f]) {
    ...
    } else for (e = 0; e < this.roots.length; e++) l = {},
    b.push(l),
    this.traverse(this.roots[e], !0, null, c, l, b, null);
    b = [];
    ...
    if (null != a && null != d) {
        ...
        if (null == d[l] && (null == g || null != g[l])) {
            ...
            for (c = 0; c < m.length; c++) {
                ...
                for (var q = 0,
                q = 0; q < this.swimlanes.length && !l.isAncestor(this.swimlanes[q], n); q++);
...
mxSwimlaneLayout.prototype.cycleStage = function(a) { (new mxSwimlaneOrdering(this)).execute(a)
};
mxSwimlaneLayout.prototype.layeringStage = function() {
    this.model.initialRank();
    this.model.fixRanks()
};
mxSwimlaneLayout.prototype.crossingStage = function(a) { (new mxMedianHybridCrossingReduction(this)).execute(a)
};
...
mxGraphModel.prototype.cellAdded = function(a) {
    if (null != a) {
        ...
        if (null != a.getId()) {
            ...
            if (b != a) {
                for (; null != b;) a.setId(this.createId(a)),
...
mxGraphModel.prototype.parentForCellChanged = function(a, b, c) {
    ...
    null != b ? (b != d || d.getIndex(a) != c) && b.insert(a, c) : null != d && (c = d.getIndex(a), d.remove(c)); ! this.contains(d) && null != b ? this.cellAdded(a) : null == b && this.cellRemoved(a);
    return d
};
...
mxGraphModel.prototype.getChildCells = function(a, b, c) {
    ...
    for (var d = this.getChildCount(a), e = [], f = 0; f < d; f++) {
        var g = this.getChildAt(a, f); (!c && !b || c && this.isEdge(g) || b && this.isVertex(g)) && e.push(g)
    }
    return e
};
...
mxGraphModel.prototype.setTerminals = function(a, b, c) {
    this.beginUpdate();
    try {
        this.setTerminal(a, b, !0),
        this.setTerminal(a, c, !1)
    } finally {
        this.endUpdate()
    }
};
...
mxGraphModel.prototype.getDirectedEdgeCount = function(a, b, c) {
    for (var d = 0,
    e = this.getEdgeCount(a), f = 0; f < e; f++) {
...
mxGraphModel.prototype.getEdges = function(a, b, c, d) {
    ...
    for (var e = this.getEdgeCount(a), f = [], g = 0; g < e; g++) {
        ...
        m = this.getTerminal(k, !1); (d && l == m || l != m && (b && m == a || c && l == a)) && f.push(k)
    }
    return f
};
mxGraphModel.prototype.getEdgesBetween = function(a, b, c) {
    ...
    for (e = 0; e < g; e++) {
        ...
        n = m == a && l == b; (l == a && m == b || !c && n) && d.push(k)
    }
    return d
};
...
mxGraphModel.prototype.cloneCells = function(a, b) {
    for (var c = {},
    d = [], e = 0; e < a.length; e++) null != a[e] ? d.push(this.cloneCellImpl(a[e], c, b)) : d.push(null);
...
mxGeometry.prototype.rotate = function(a, b) {
    ...
    null != this.targetPoint && (e = mxUtils.getRotatedPoint(this.targetPoint, d, c, b), this.targetPoint.x = Math.round(e.x), this.targetPoint.y = Math.round(e.y));
...
mxGeometry.prototype.translate = function(a, b) {
    ...
    if (this.TRANSLATE_CONTROL_POINTS && null != this.points) for (var c = 0; c < this.points.length; c++) null != this.points[c] && (this.points[c].x = parseFloat(this.points[c].x) + a, this.points[c].y = parseFloat(this.points[c].y) + b)
};
mxGeometry.prototype.scale = function(a, b) {
    a = parseFloat(a);
    b = parseFloat(b);
    this.relative || (this.x = parseFloat(this.x) * a, this.y = parseFloat(this.y) * b, this.width = parseFloat(this.width) * a, this.height = parseFloat(this.height) * b);
    null != this.sourcePoint && (this.sourcePoint.x = parseFloat(this.sourcePoint.x) * a, this.sourcePoint.y = parseFloat(this.sourcePoint.y) * b);
    null != this.targetPoint && (this.targetPoint.x = parseFloat(this.targetPoint.x) * a, this.targetPoint.y = parseFloat(this.targetPoint.y) * b);
    if (null != this.points) for (var c = 0; c < this.points.length; c++) null != this.points[c] && (this.points[c].x = parseFloat(this.points[c].x) * a, this.points[c].y = parseFloat(this.points[c].y) * b)
};
...
mxPerimeter = {
    ...
    EllipsePerimeter: function(a, b, c, d) {
        ...
        var n = parseInt(b - l),
        p = parseInt(c - m);
        if (0 == n && 0 != p) return new mxPoint(l, m + k * p / Math.abs(p));
        if (0 == n && 0 == p) return new mxPoint(b, c);
        if (d) {
            if (c >= f && c <= f + a.height) return a = c - m,
            a = Math.sqrt(g * g * (1 - a * a / (k * k))) || 0,
            b <= e && (a = -a),
            new mxPoint(l + a, c);
            if (b >= e && b <= e + a.width) return a = b - l,
    ...
    TrianglePerimeter: function(a, b, c, d) {
        ...
        t = null;
        s ? t = d && (e && c.x >= n.x && c.x <= q.x || !e && c.y >= n.y && c.y <= q.y) ? e ? new mxPoint(c.x, n.y) : new mxPoint(n.x, c.y) : b == mxConstants.DIRECTION_NORTH ? new mxPoint(f + k / 2 + a * Math.tan(r) / 2, g + a) : b == mxConstants.DIRECTION_SOUTH ? new mxPoint(f + k / 2 - a * Math.tan(r) / 2, g) : b == mxConstants.DIRECTION_WEST ? new mxPoint(f + k, g + a / 2 + k * Math.tan(r) / 2) : new mxPoint(f, g + a / 2 - k * Math.tan(r) / 2) : (d && (d = new mxPoint(l, m), c.y >= g && c.y <= g + a ? (d.x = e ? l: b == mxConstants.DIRECTION_WEST ? f + k: f, d.y = c.y) : c.x >= f && c.x <= f + k && (d.x = c.x, d.y = !e ? m: b == mxConstants.DIRECTION_NORTH ? g + a: g), l = d.x, m = d.y), t = e && c.x <= f + k / 2 || !e && c.y <= g + a / 2 ? mxUtils.intersection(c.x, c.y, l, m, n.x, n.y, p.x, p.y) : mxUtils.intersection(c.x, c.y, l, m, p.x, p.y, q.x, q.y));
        ...
        if (d) {
            if (t) {
                if (m == l) {
                    ...
                    if (n == f + 3 * k / 4) return new mxPoint(e, f + 3 * k / 4)
                } else if (m > e + g) {
            ...
            if (t) {
                ...
                p < m && p > -m ? (b = new mxPoint(e + g, f), s = new mxPoint(e + g, f + k)) : p > m && p < r ? (b = new mxPoint(e, f - Math.floor(0.25 * k)), s = new mxPoint(e + Math.floor(1.5 * g), f + Math.floor(0.5 * k))) : p > r && p < q - m ? (b = new mxPoint(e - Math.floor(0.5 * g), f + Math.floor(0.5 * k)), s = new mxPoint(e + g, f - Math.floor(0.25 * k))) : p > q - m && p <= q || p < -q + m && p >= -q ? (b = new mxPoint(e, f), s = new mxPoint(e, f + k)) : p < -m && p > -r ? (b = new mxPoint(e + Math.floor(1.5 * g), f + Math.floor(0.5 * k)), s = new mxPoint(e, f + Math.floor(1.25 * k))) : p < -r && p > -q + m && (b = new mxPoint(e - Math.floor(0.5 * g), f + Math.floor(0.5 * k)), s = new mxPoint(e + g, f + Math.floor(1.25 * k)))
            } else {
                ...
                0 < p && p < m ? (b = new mxPoint(e + Math.floor(0.5 * g), f - Math.floor(0.5 * k)), s = new mxPoint(e + Math.floor(1.25 * g), f + k)) : p > m && p < q - m ? (b = new mxPoint(e, f), s = new mxPoint(e + g, f)) : p > q - m && p < q ? (b = new mxPoint(e - Math.floor(0.25 * g), f + k), s = new mxPoint(e + Math.floor(0.5 * g), f - Math.floor(0.5 * k))) : 0 > p && p > -m ? (b = new mxPoint(e + Math.floor(0.5 * g), f + Math.floor(1.5 * k)), s = new mxPoint(e + Math.floor(1.25 * g), f)) : p < -m && p > -q + m ? (b = new mxPoint(e, f + k), s = new mxPoint(e + g, f + k)) : p < -q + m && p > -q && (b = new mxPoint(e - Math.floor(0.25 * g), f), s = new mxPoint(e + Math.floor(0.5 * g), f + Math.floor(1.5 * k)))
            }
...
mxPrintPreview.prototype.open = function(a) {
    ...
    try {
        ...
        if (null == this.wnd) {
            ...
            mxClient.IS_VML ? d.writeln('<html xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">') : ("CSS1Compat" === document.compatMode && d.writeln("<!DOCTYPE html>"), d.writeln("<html>"));
            d.writeln("<head>");
            this.writeHead(d, a);
            d.writeln("</head>");
            ...
            p = Math.max(1, Math.ceil((f.width + this.x0) / m)),
            ...
            if (null != s) for (var t = 0; t < s.length; t++) a(s[t], !0);
            for (var u = this.getAppendices(this.pageFormat.width, this.pageFormat.height), t = 0; t < q; t++) for (var x = t * n / this.scale - this.y0 / this.scale + (f.y - l.y * g) / g, s = 0; s < p; s++) {
                ...
                })) : this.renderPage(this.pageFormat.width, this.pageFormat.height, 0, 0, mxUtils.bind(this,
                function(a) {
            ...
            if (null != u) for (t = 0; t < u.length; t++) a(u[t], t < u.length);
            d.writeln("</body>");
            d.writeln("</html>");
            d.close();
            r();
...
mxPrintPreview.prototype.renderPage = function(a, b, c, d, e) {
    ...
    try {
        if (0 != c || 0 != d) {
            ...
            k = m
        } else g.style.width = a + "px",
        g.style.height = b + "px",
        g.style.overflow = "hidden",
        g.style.pageBreakInside = "avoid",
        8 == f.documentMode && (g.style.position = "relative"),
        l = document.createElement("div"),
        l.style.width = a - 2 * this.border + "px",
        l.style.height = b - 2 * this.border + "px",
        l.style.overflow = "hidden",
        mxClient.IS_IE && (null == f.documentMode || 5 == f.documentMode || 8 == f.documentMode || 7 == f.documentMode) ? (l.style.marginTop = this.border + "px", l.style.marginLeft = this.border + "px") : (l.style.top = this.border + "px", l.style.left = this.border + "px"),
        this.graph.dialect == mxConstants.DIALECT_VML && (l.style.position = "absolute"),
        g.appendChild(l),
        document.body.appendChild(g),
        k = l
    } catch(n) {
        throw g.parentNode.removeChild(g),
        n;
    }
    e(k);
    return g
...
mxPrintPreview.prototype.addGraphFragment = function(a, b, c, d, e, f) {
    ...
    try {
        ...
        else for (c = e.firstChild; null != c;) r = c.nextSibling,
        b = c.nodeName.toLowerCase(),
        "svg" == b ? (c.setAttribute("width", parseInt(e.style.width)), c.setAttribute("height", parseInt(e.style.height))) : "default" != c.style.cursor && "div" != b && c.parentNode.removeChild(c),
        c = r;
...
mxStylesheet.prototype.getCellStyle = function(a, b) {
    var c = b;
    if (null != a && 0 < a.length) for (var d = a.split(";"), c = null != c && ";" != a.charAt(0) ? mxUtils.clone(c) : {},
    e = 0; e < d.length; e++) {
        var f = d[e],
        g = f.indexOf("=");
        if (0 <= g) {
...
mxCellEditor.prototype.installListeners = function(a) {
    mxEvent.addListener(a, "blur", mxUtils.bind(this,
    function(a) {
        this.focusLost(a)
    }));
    mxEvent.addListener(a, "change", mxUtils.bind(this,
    function(a) {
        this.setModified(!0)
    }));
    mxEvent.addListener(a, "keydown", mxUtils.bind(this,
    function(b) {
    ...
    mxEvent.addListener(a, !mxClient.IS_IE || 9 <= document.documentMode ? "input": "keypress", mxUtils.bind(this,
    function(a) {
        this.autoSize && !mxEvent.isConsumed(a) && setTimeout(mxUtils.bind(this,
        function() {
            this.resize()
        }), 0)
    }))
...
mxCellEditor.prototype.resize = function() {
    if (null != this.textDiv) {
        ...
        if (null == a) this.stopEditing(!0);
            ...
            k = (parseInt(a.style[mxConstants.STYLE_SPACING_RIGHT] || 0) + mxText.prototype.baseSpacingRight) * e + f,
...
mxCellEditor.prototype.startEditing = function(a, b) {
    ...
    if (null != c) {
        ...
        "none" != this.textarea.style.display && (this.autoSize && (this.textDiv = this.createTextDiv(), document.body.appendChild(this.textDiv), this.resize()), this.textarea.focus(), this.isSelectText() && 0 < this.textarea.value.length && (mxClient.IS_IOS ? document.execCommand("selectAll") : this.textarea.select()))
    }
};
...
mxCellEditor.prototype.getEditorBounds = function(a) {
    ...
    this.graph.getModel().isVertex(a.cell) && (b = mxUtils.getValue(a.style, mxConstants.STYLE_LABEL_POSITION, mxConstants.ALIGN_CENTER), b == mxConstants.ALIGN_LEFT ? k.x -= a.width: b == mxConstants.ALIGN_RIGHT && (k.x += a.width), b = mxUtils.getValue(a.style, mxConstants.STYLE_VERTICAL_LABEL_POSITION, mxConstants.ALIGN_MIDDLE), b == mxConstants.ALIGN_TOP ? k.y -= a.height: b == mxConstants.ALIGN_BOTTOM && (k.y += a.height));
    return k
};
...
mxCellRenderer.prototype.createLabel = function(a, b) {
    ...
    if (0 < a.style[mxConstants.STYLE_FONTSIZE] || null == a.style[mxConstants.STYLE_FONTSIZE]) {
        ...
        f = function(b) {
            var d = a;
            if (mxClient.IS_TOUCH || e) d = mxEvent.getClientX(b),
            b = mxEvent.getClientY(b),
            b = mxUtils.convertPoint(c.container, d, b),
            d = c.view.getState(c.getCellAt(b.x, b.y));
            return d
        };
        mxEvent.addGestureListeners(a.text.node, mxUtils.bind(this,
        function(b) {
            this.isLabelEvent(a, b) && (c.fireMouseEvent(mxEvent.MOUSE_DOWN, new mxMouseEvent(b, a)), e = c.dialect != mxConstants.DIALECT_SVG && "IMG" == mxEvent.getSource(b).nodeName)
        }), mxUtils.bind(this,
        function(b) {
        ...
        c.nativeDblClickEnabled && mxEvent.addListener(a.text.node, "dblclick", mxUtils.bind(this,
        function(b) {
...
mxCellRenderer.prototype.createCellOverlays = function(a) {
    ...
    c = null;
    if (null != b) for (var c = new mxDictionary,
    d = 0; d < b.length; d++) {
...
mxCellRenderer.prototype.installCellOverlayListeners = function(a, b, c) {
    ...
    mxClient.IS_TOUCH && mxEvent.addListener(c.node, "touchend",
    function(c) {
        b.fireEvent(new mxEventObject(mxEvent.CLICK, "event", c, "cell", a.cell))
    })
};
mxCellRenderer.prototype.createControl = function(a) {
    ...
    if (b.foldingEnabled && null != c) {
        if (null == a.control) {
            ...
            this.initControl(a, a.control, !0,
            function(c) {
                if (b.isEnabled()) {
...
mxCellRenderer.prototype.initControl = function(a, b, c, d) {
    ...
    c && mxEvent.addGestureListeners(b,
    function(b) {
...
mxCellRenderer.prototype.installListeners = function(a) {
    ...
    c = function(c) {
        var e = a;
        if (b.dialect != mxConstants.DIALECT_SVG && "IMG" == mxEvent.getSource(c).nodeName || mxClient.IS_TOUCH) e = mxEvent.getClientX(c),
        c = mxEvent.getClientY(c),
        c = mxUtils.convertPoint(b.container, e, c),
        e = b.view.getState(b.getCellAt(c.x, c.y));
        return e
    };
    mxEvent.addGestureListeners(a.shape.node, mxUtils.bind(this,
    function(c) {
        this.isShapeEvent(a, c) && b.fireMouseEvent(mxEvent.MOUSE_DOWN, new mxMouseEvent(c, null != a.shape && mxEvent.getSource(c) == a.shape.content ? null: a))
    }), mxUtils.bind(this,
    function(d) {
    ...
    b.nativeDblClickEnabled && mxEvent.addListener(a.shape.node, "dblclick", mxUtils.bind(this,
    function(c) {
...
mxCellRenderer.prototype.redrawLabel = function(a, b) {
    ...
    else if (null != a.text && (null == c || 0 == c.length)) a.text.destroy(),
    a.text = null;
    if (null != a.text) {
        var d = a.view.graph,
        ...
        if (b || a.text.value != c || a.text.isWrapping != e || a.text.isClipping != d || a.text.scale != a.view.scale || a.text.dialect != g || !a.text.bounds.equals(f)) a.text.dialect = g,
        a.text.value = c,
        a.text.bounds = f,
        a.text.scale = this.getTextScale(a),
        a.text.isWrapping = e,
        a.text.isClipping = d,
        a.text.redraw()
    }
...
mxCellRenderer.prototype.getLabelBounds = function(a) {
    ...
    } else a.text.isPaintBoundsInverted() && (b = e.x, e.x = e.y, e.y = b),
    e.x += a.x,
    e.y += a.y,
...
mxCellRenderer.prototype.rotateLabelBounds = function(a, b) {
    ...
    if (0 != e && (null != a && a.view.graph.model.isVertex(a.cell)) && (c = a.getCenterX(), d = a.getCenterY(), b.x != c || b.y != d)) e *= Math.PI / 180,
...
mxCellRenderer.prototype.redrawCellOverlays = function(a, b) {
    ...
    if (null != a.overlays) {
        ...
        a.overlays.visit(function(d, k) {
            ...
            if (b || null == k.bounds || k.scale != a.view.scale || !k.bounds.equals(l)) k.bounds = l,
            k.scale = a.view.scale,
            k.redraw()
        })
    }
};
mxCellRenderer.prototype.redrawControl = function(a, b) {
    ...
    if (null != a.control && null != c) {
        ...
        e = a.view.scale;
        if (b || a.control.scale != e || !a.control.bounds.equals(c) || a.control.rotation != d) a.control.rotation = d,
        a.control.bounds = c,
        a.control.scale = e,
        a.control.redraw()
    }
...
mxCellRenderer.prototype.getControlBounds = function(a, b, c) {
    if (null != a.control) {
        ...
        return a.view.graph.getModel().isEdge(a.cell),
...
mxCellRenderer.prototype.redraw = function(a, b, c) {
    ...
    if (null != a.shape && (null == c || c)) this.redrawLabel(a, b),
    this.redrawCellOverlays(a, b),
    this.redrawControl(a, b)
};
mxCellRenderer.prototype.redrawShape = function(a, b, c) {
    var d = !1;
    if (null != a.shape && (null == a.shape.node && (this.createIndicatorShape(a), this.initializeShape(a), this.createCellOverlays(a), this.installListeners(a)), this.createControl(a), mxUtils.equalEntries(a.shape.style, a.style) || (this.configureShape(a), b = !0), b || null == a.shape.bounds || a.shape.scale != a.view.scale || null == a.absolutePoints && !a.shape.bounds.equals(a) || null != a.absolutePoints && !mxUtils.equalPoints(a.shape.points, a.absolutePoints))) null != a.absolutePoints ? (a.shape.points = a.absolutePoints.slice(), a.shape.bounds = null) : (a.shape.points = null, a.shape.bounds = new mxRectangle(a.x, a.y, a.width, a.height)),
    a.shape.scale = a.view.scale,
    null == c || c ? a.shape.redraw() : a.shape.updateBoundingBox(),
    d = !0;
    return d
};
...
var mxEdgeStyle = {
    EntityRelation: function(a, b, c, d, e) {
        ...
        null != b && null != c && (a = k ? b.x: b.x + b.width, b = f.getRoutingCenterY(b), g = l ? c.x: c.x + c.width, c = f.getRoutingCenterY(c), f = new mxPoint(a + (k ? -d: d), b), m = new mxPoint(g + (l ? -d: d), c), k == l ? (d = k ? Math.min(a, g) - d: Math.max(a, g) + d, e.push(new mxPoint(d, b)), e.push(new mxPoint(d, c))) : (f.x < m.x == k ? (d = b + (c - b) / 2, e.push(f), e.push(new mxPoint(f.x, d)), e.push(new mxPoint(m.x, d))) : e.push(f), e.push(m)))
    },
    Loop: function(a, b, c, d, e) {
        c = a.absolutePoints;
        var f = c[c.length - 1];
        if (null != c[0] && null != f) {
            if (null != d && 0 < d.length) for (b = 0; b < d.length; b++) c = d[b],
            c = a.view.transformControlPoint(a, c),
            e.push(new mxPoint(c.x, c.y))
        } else if (null != b) {
            var f = a.view,
            g = f.graph;
    ...
    ElbowConnector: function(a, b, c, d, e) {
        ...
        g = f.y < k || f.y > n,
        k = f.x < l || f.x > m;
        else l = Math.max(b.x, c.x),
        m = Math.min(b.x + b.width, c.x + c.width),
        g = l == m,
        g || (k = Math.max(b.y, c.y), n = Math.min(b.y + b.height, c.y + c.height), k = k == n); ! k && (g || a.style[mxConstants.STYLE_ELBOW] == mxConstants.ELBOW_VERTICAL) ? mxEdgeStyle.TopToBottom(a, b, c, d, e) : mxEdgeStyle.SideToSide(a, b, c, d, e)
    },
    SideToSide: function(a, b, c, d, e) {
        ...
        null != b && null != c && (a = Math.max(b.x, c.x), k = Math.min(b.x + b.width, c.x + c.width), a = null != d ? d.x: k + (a - k) / 2, k = f.getRoutingCenterY(b), f = f.getRoutingCenterY(c), null != d && (d.y >= b.y && d.y <= b.y + b.height && (k = d.y), d.y >= c.y && d.y <= c.y + c.height && (f = d.y)), !mxUtils.contains(c, a, k) && !mxUtils.contains(b, a, k) && e.push(new mxPoint(a, k)), !mxUtils.contains(c, a, f) && !mxUtils.contains(b, a, f) && e.push(new mxPoint(a, f)), 1 == e.length && (null != d ? !mxUtils.contains(c, a, d.y) && !mxUtils.contains(b, a, d.y) && e.push(new mxPoint(a, d.y)) : (f = Math.max(b.y, c.y), b = Math.min(b.y + b.height, c.y + c.height), e.push(new mxPoint(a, f + (b - f) / 2)))))
    },
    ...
    SegmentConnector: function(a, b, c, d, e) {
        ...
        k = null,
        l = f[0];
        null == l && null != b ? l = new mxPoint(a.view.getRoutingCenterX(b), a.view.getRoutingCenterY(b)) : null != l && (l = l.clone());
        var m = f.length - 1;
        if (null != d && 0 < d.length) {
            ...
            g ? l.y = k.y: l.x = k.x;
            for (t = 0; t < d.length; t++) g = !g,
            k = a.view.transformControlPoint(a, d[t]),
            g ? l.y = k.y: l.x = k.x,
            e.push(l.clone())
        } else k = l,
        g = !0;
        ...
        g && (null != f[m] && f[m].y != k.y || null == f[m] && null != c && (k.y < c.y || k.y > c.y + c.height)) ? e.push(new mxPoint(l.x, k.y)) : !g && (null != f[m] && f[m].x != k.x || null == f[m] && null != c && (k.x < c.x || k.x > c.x + c.width)) && e.push(new mxPoint(k.x, l.y));
        if (null == f[0] && null != b) for (; 1 < e.length && mxUtils.contains(b, e[1].x, e[1].y);) e = e.splice(1, 1);
        if (null == f[m] && null != c) for (; 1 < e.length && mxUtils.contains(c, e[e.length - 1].x, e[e.length - 1].y);) e = e.splice(e.length - 1, 1)
    },
    orthBuffer: 10,
    ...
    OrthConnector: function(a, b, c, d, e) {
        ...
        if (mxEdgeStyle.orthPointsFallback && null != d && 0 < d.length || g || f) mxEdgeStyle.SegmentConnector(a, b, c, d, e);
            ...
            u = 0;
            null != b && (t[0] = mxUtils.getPortConstraints(b, a, !0, mxConstants.DIRECTION_MASK_ALL), u = mxUtils.getValue(b.style, mxConstants.STYLE_ROTATION, 0), 0 != u && (u = mxUtils.getBoundingBox(new mxRectangle(d, g, m, n), u), d = u.x, g = u.y, m = u.width, n = u.height));
            ...
            a = [0, 0];
            d = [[d, g, m, n], [p, q, r, s]];
            for (m = 0; 2 > m; m++) mxEdgeStyle.limits[m][1] = d[m][0] - f,
            mxEdgeStyle.limits[m][2] = d[m][1] - f,
            mxEdgeStyle.limits[m][4] = d[m][0] + d[m][2] + f,
            mxEdgeStyle.limits[m][8] = d[m][1] + d[m][3] + f;
            ...
            null != b && (n = k);
            b = [[0.5, 0.5], [0.5, 0.5]];
            for (m = 0; 2 > m; m++) null != n && (b[m][0] = (n.x - d[m][0]) / d[m][2], 0.01 > b[m][0] ? a[m] = mxConstants.DIRECTION_MASK_WEST: 0.99 < b[m][0] && (a[m] = mxConstants.DIRECTION_MASK_EAST), b[m][1] = (n.y - d[m][1]) / d[m][3], 0.01 > b[m][1] ? a[m] = mxConstants.DIRECTION_MASK_NORTH: 0.99 < b[m][1] && (a[m] = mxConstants.DIRECTION_MASK_SOUTH)),
            n = null,
            null != c && (n = l);
            m = d[0][1] - (d[1][1] + d[1][3]);
            n = d[0][0] - (d[1][0] + d[1][2]);
            ...
            for (m = 0; 2 > m; m++) if (0 == a[m] && (0 == (q[m][0] & t[m]) && (q[m][0] = q[m][1]), c[m] = q[m][0] & t[m], c[m] |= (q[m][1] & t[m]) << 8, c[m] |= (q[1 - m][m] & t[m]) << 16, c[m] |= (q[1 - m][1 - m] & t[m]) << 24, 0 == (c[m] & 15) && (c[m] <<= 8), 0 == (c[m] & 3840) && (c[m] = c[m] & 15 | c[m] >> 8), 0 == (c[m] & 983040) && (c[m] = c[m] & 65535 | (c[m] & 251658240) >> 8), a[m] = c[m] & 15, t[m] == mxConstants.DIRECTION_MASK_WEST || t[m] == mxConstants.DIRECTION_MASK_NORTH || t[m] == mxConstants.DIRECTION_MASK_EAST || t[m] == mxConstants.DIRECTION_MASK_SOUTH)) a[m] = t[m];
            ...
            case mxConstants.DIRECTION_MASK_NORTH:
                mxEdgeStyle.wayPoints1[0][0] += b[0][0] * d[0][2],
                mxEdgeStyle.wayPoints1[0][1] -= f
            }
            f = 0;
            k = c = 0 < (a[0] & (mxConstants.DIRECTION_MASK_EAST | mxConstants.DIRECTION_MASK_WEST)) ? 0 : 1;
            for (m = l = 0; m < t.length; m++) l = t[m] & 15,
            s = l == mxConstants.DIRECTION_MASK_EAST ? 3 : l,
            s += g,
            4 < s && (s -= 4),
            n = mxEdgeStyle.dirVectors[s - 1],
            l = 0 < s % 2 ? 0 : 1,
            l != c && (f++, mxEdgeStyle.wayPoints1[f][0] = mxEdgeStyle.wayPoints1[f - 1][0], mxEdgeStyle.wayPoints1[f][1] = mxEdgeStyle.wayPoints1[f - 1][1]),
            u = 0 < (t[m] & mxEdgeStyle.TARGET_MASK),
            r = 0 < (t[m] & mxEdgeStyle.SOURCE_MASK),
            p = (t[m] & mxEdgeStyle.SIDE_MASK) >> 5,
            p <<= g,
            15 < p && (p >>= 4),
            q = 0 < (t[m] & mxEdgeStyle.CENTER_MASK),
            (r || u) && 9 > p ? (s = 0, r = r ? 0 : 1, s = q && 0 == l ? d[r][0] + b[r][0] * d[r][2] : q ? d[r][1] + b[r][1] * d[r][3] : mxEdgeStyle.limits[r][p], 0 == l ? (p = (s - mxEdgeStyle.wayPoints1[f][0]) * n[0], 0 < p && (mxEdgeStyle.wayPoints1[f][0] += n[0] * p)) : (p = (s - mxEdgeStyle.wayPoints1[f][1]) * n[1], 0 < p && (mxEdgeStyle.wayPoints1[f][1] += n[1] * p))) : q && (mxEdgeStyle.wayPoints1[f][0] += n[0] * Math.abs(mxEdgeStyle.vertexSeperations[s] / 2), mxEdgeStyle.wayPoints1[f][1] += n[1] * Math.abs(mxEdgeStyle.vertexSeperations[s] / 2)),
            0 < f && mxEdgeStyle.wayPoints1[f][l] == mxEdgeStyle.wayPoints1[f - 1][l] ? f--:c = l;
            for (m = 0; m <= f && !(m == f && ((0 < (a[1] & (mxConstants.DIRECTION_MASK_EAST | mxConstants.DIRECTION_MASK_WEST)) ? 0 : 1) == k ? 0 : 1) != (f + 1) % 2); m++) e.push(new mxPoint(mxEdgeStyle.wayPoints1[m][0], mxEdgeStyle.wayPoints1[m][1]))
        }
    },
...
mxGraphView.prototype.scaleAndTranslate = function(a, b, c) {
    ...
    if (this.scale != a || this.translate.x != b || this.translate.y != c) this.scale = a,
    this.translate.x = b,
    this.translate.y = c,
    this.isEventsEnabled() && (this.revalidate(), this.graph.sizeDidChange());
...
mxGraphView.prototype.setTranslate = function(a, b) {
    ...
    if (this.translate.x != a || this.translate.y != b) this.translate.x = a,
    this.translate.y = b,
    this.isEventsEnabled() && (this.revalidate(), this.graph.sizeDidChange());
...
mxGraphView.prototype.validate = function(a) {
    ...
    var c = null;
    if (this.optimizeVmlReflows && null != this.canvas && null == this.textDiv && (8 == document.documentMode || mxClient.IS_QUIRKS)) this.placeholder = document.createElement("div"),
...
mxGraphView.prototype.validateBackgroundImage = function() {
    ...
    if (null != a) {
        if (null == this.backgroundImage || this.backgroundImage.image != a.src) {
            ...
            8 == document.documentMode && mxEvent.addGestureListeners(this.backgroundImage.node, mxUtils.bind(this,
            function(a) {
...
mxGraphView.prototype.validateBackgroundPage = function() {
    if (this.graph.pageVisible) {
        ...
        null == this.backgroundPageShape ? (this.backgroundPageShape = this.createBackgroundPageShape(a), this.backgroundPageShape.scale = this.scale, this.backgroundPageShape.isShadow = !0, this.backgroundPageShape.dialect = this.graph.dialect, this.backgroundPageShape.init(this.backgroundPane), this.backgroundPageShape.redraw(), this.graph.nativeDblClickEnabled && mxEvent.addListener(this.backgroundPageShape.node, "dblclick", mxUtils.bind(this,
        function(a) {
            this.graph.dblClick(a)
        })), mxEvent.addGestureListeners(this.backgroundPageShape.node, mxUtils.bind(this,
        function(a) {
            this.graph.fireMouseEvent(mxEvent.MOUSE_DOWN, new mxMouseEvent(a))
        }), mxUtils.bind(this,
        function(a) {
...
mxGraphView.prototype.updateCellState = function(a) {
    ...
    if (a.cell != this.currentRoot) {
        ...
        null != e && (b.isEdge(a.cell) || (d = e.offset || this.EMPTY_POINT, e.relative && null != c ? b.isEdge(c.cell) ? (d = this.getPoint(c, e), null != d && (a.origin.x += d.x / this.scale - c.origin.x - this.translate.x, a.origin.y += d.y / this.scale - c.origin.y - this.translate.y)) : (a.origin.x += e.x * c.width / this.scale + d.x, a.origin.y += e.y * c.height / this.scale + d.y) : (a.absoluteOffset.x = this.scale * d.x, a.absoluteOffset.y = this.scale * d.y, a.origin.x += e.x, a.origin.y += e.y)), a.x = this.scale * (this.translate.x + a.origin.x), a.y = this.scale * (this.translate.y + a.origin.y), a.width = this.scale * e.width, a.height = this.scale * e.height, b.isVertex(a.cell) && this.updateVertexState(a, e), b.isEdge(a.cell) && this.updateEdgeState(a, e))
    }
};
...
mxGraphView.prototype.updateVertexLabelOffset = function(a) {
    ...
    if (b == mxConstants.ALIGN_LEFT) b = mxUtils.getValue(a.style, mxConstants.STYLE_LABEL_WIDTH, null),
...
mxGraphView.prototype.updatePoints = function(a, b, c, d) {
    if (null != a) {
        ...
        if (null != f) c = this.getTerminalPort(a, c, !0),
        d = this.getTerminalPort(a, d, !1),
        f(a, c, d, b, e);
        else if (null != b) for (f = 0; f < b.length; f++) null != b[f] && (d = mxUtils.clone(b[f]), e.push(this.transformControlPoint(a, d)));
        b = a.absolutePoints;
        e.push(b[b.length - 1]);
        a.absolutePoints = e
    }
...
mxGraphView.prototype.getNextPoint = function(a, b, c) {
    a = a.absolutePoints;
    var d = null;
    if (null != a && (c || 2 < a.length || null == b)) d = a.length,
...
mxGraphView.prototype.getPoint = function(a, b) {
    ...
    if (null != a.segments && (null == b || b.relative)) {
        for (var e = a.absolutePoints.length,
        f = ((null != b ? b.x / 2 : 0) + 0.5) * a.length, g = a.segments[0], k = 0, l = 1; f > k + g && l < e - 1;) k += g,
        g = a.segments[l++];
        e = 0 == g ? 0 : (f - k) / g;
...
mxGraphView.prototype.getRelativePoint = function(a, b, c) {
    ...
    if (null != d) {
        ...
        if (d.relative && 1 < e) {
            for (var d = a.length,
            f = a.segments,
            g = a.absolutePoints[0], k = a.absolutePoints[1], l = mxUtils.ptSegDistSq(g.x, g.y, k.x, k.y, b, c), m = 0, n = 0, p = 0, q = 2; q < e; q++) n += f[q - 2],
            k = a.absolutePoints[q],
...
mxGraphView.prototype.installListeners = function() {
    ...
    b = a.container;
    if (null != b) {
        mxClient.IS_TOUCH && (mxEvent.addListener(b, "gesturestart", mxUtils.bind(this,
        function(b) {
            a.fireGestureEvent(b);
            mxEvent.consume(b)
        })), mxEvent.addListener(b, "gesturechange", mxUtils.bind(this,
        function(b) {
            a.fireGestureEvent(b);
            mxEvent.consume(b)
        })), mxEvent.addListener(b, "gestureend", mxUtils.bind(this,
        function(b) {
            a.fireGestureEvent(b);
            mxEvent.consume(b)
        })));
        mxEvent.addGestureListeners(b, mxUtils.bind(this,
        function(b) {
        ...
        function(b) {
            ...
            this.captureDocumentGesture && (a.isMouseDown && null != a.container && !this.isContainerEvent(b) && "none" != a.container.style.display && "hidden" != a.container.style.visibility && !mxEvent.isConsumed(b)) && a.fireMouseEvent(mxEvent.MOUSE_MOVE, new mxMouseEvent(b, c(b)))
        });
        this.endHandler = mxUtils.bind(this,
        function(b) {
...
mxGraphView.prototype.createHtml = function() {
    ...
    null != a && (this.canvas = this.createHtmlPane("100%", "100%"), this.backgroundPane = this.createHtmlPane("1px", "1px"), this.drawPane = this.createHtmlPane("1px", "1px"), this.overlayPane = this.createHtmlPane("1px", "1px"), this.decoratorPane = this.createHtmlPane("1px", "1px"), this.canvas.appendChild(this.backgroundPane), this.canvas.appendChild(this.drawPane), this.canvas.appendChild(this.overlayPane), this.canvas.appendChild(this.decoratorPane), a.appendChild(this.canvas), mxClient.IS_QUIRKS && (a = mxUtils.bind(this,
    function(a) {
...
function mxCurrentRootChange(a, b) {
    ...
    this.previous = this.root = b;
    this.isUp = null == b;
    if (!this.isUp) for (var c = this.view.currentRoot,
    d = this.view.graph.getModel(); null != c;) {
        if (c == b) {
            this.isUp = !0;
            break
        }
...
mxGraph.prototype.init = function(a) {
    ...
    this.view.init();
    this.sizeDidChange();
    mxEvent.addListener(a, "mouseleave", mxUtils.bind(this,
    function() {
...
mxGraph.prototype.processChange = function(a) {
    if (a instanceof mxRootChange) this.clearSelection(),
    ...
    this.fireEvent(new mxEventObject(mxEvent.ROOT));
        ...
        if (null == b || this.isCellCollapsed(b)) this.view.invalidate(a.child, !0, !0),
...
mxGraph.prototype.setCellWarning = function(a, b, c, d) {
    if (null != b && 0 < b.length) return c = null != c ? c: this.warningImage,
...
mxGraph.prototype.startEditingAtCell = function(a, b) {
    if (null == b || !mxEvent.isMultiTouchEvent(b)) null == a && (a = this.getSelectionCell(), null != a && !this.isCellEditable(a) && (a = null)),
        ...
        if (a >= e.scrollLeft && b >= e.scrollTop && a <= e.scrollLeft + e.clientWidth && b <= e.scrollTop + e.clientHeight) {
            ...
            if (f < d) {
                if (a = e.scrollLeft, e.scrollLeft += d - f, c && a == e.scrollLeft) {
                    ...
                    } else g = Math.max(e.clientWidth, e.scrollWidth) + d - f,
                    a = this.view.getCanvas();
                    a.style.width = g + "px";
                    e.scrollLeft += d - f
                }
            } else f = a - e.scrollLeft,
            f < d && (e.scrollLeft -= d - f);
            f = e.scrollTop + e.clientHeight - b;
            f < d ? (a = e.scrollTop, e.scrollTop += d - f, a == e.scrollTop && c && (this.dialect == mxConstants.DIALECT_SVG ? (a = this.view.getDrawPane().ownerSVGElement, b = this.container.scrollHeight + d - f) : (b = Math.max(e.clientHeight, e.scrollHeight) + d - f, a = this.view.getCanvas()), a.style.height = b + "px", e.scrollTop += d - f)) : (f = b - e.scrollTop, f < d && (e.scrollTop -= d - f))
        }
...
mxGraph.prototype.updatePageBreaks = function(a, b, c) {
    ...
    if (null != this.horizontalPageBreaks) {
        for (f = 0; f <= e; f++) g = [new mxPoint(d.x + f * d.width, 1), new mxPoint(d.x + f * d.width, c)],
        null != this.horizontalPageBreaks[f] ? (this.horizontalPageBreaks[f].points = g, this.horizontalPageBreaks[f].redraw()) : (g = new mxPolyline(g, this.pageBreakColor), g.dialect = this.dialect, g.pointerEvents = !1, g.isDashed = this.pageBreakDashed, g.init(this.view.backgroundPane), g.redraw(), this.horizontalPageBreaks[f] = g);
    ...
    if (null != this.verticalPageBreaks) {
        for (f = 0; f <= a; f++) g = [new mxPoint(1, d.y + f * d.height), new mxPoint(b, d.y + f * d.height)],
        null != this.verticalPageBreaks[f] ? (this.verticalPageBreaks[f].points = g, this.verticalPageBreaks[f].redraw()) : (g = new mxPolyline(g, this.pageBreakColor), g.dialect = this.dialect, g.pointerEvents = !1, g.isDashed = this.pageBreakDashed, g.init(this.view.backgroundPane), g.redraw(), this.verticalPageBreaks[f] = g);
...
mxGraph.prototype.toggleCellStyles = function(a, b, c) {
    ...
    var d = null;
    if (null != c && 0 < c.length) {
        var e = this.view.getState(c[0]),
        e = null != e ? e.style: this.getCellStyle(c[0]);
        null != e && (d = mxUtils.getValue(e, a, b) ? 0 : 1, this.setCellStyles(a, d, c))
    }
    return d
};
...
mxGraph.prototype.cloneCells = function(a, b) {
    ...
    if (null != a) {
        ...
        if (0 < c.length) for (var f = this.view.scale,
        g = this.view.translate,
        c = this.model.cloneCells(a, !0), e = 0; e < a.length; e++) if (!b && this.model.isEdge(c[e]) && null != this.getEdgeValidationError(c[e], this.model.getTerminal(c[e], !0), this.model.getTerminal(c[e], !1))) c[e] = null;
        else {
            ...
            if (null != k) {
                ...
                if (null != l && null != m) {
                    ...
                    if (this.model.isEdge(c[e])) {
                        for (var l = l.absolutePoints,
                        p = this.model.getTerminal(a[e], !0), q = mxCellPath.create(p); null != p && null == d[q];) p = this.model.getParent(p),
                        q = mxCellPath.create(p);
                        null == p && k.setTerminalPoint(new mxPoint(l[0].x / f - g.x, l[0].y / f - g.y), !0);
                        p = this.model.getTerminal(a[e], !1);
                        for (q = mxCellPath.create(p); null != p && null == d[q];) p = this.model.getParent(p),
                        q = mxCellPath.create(p);
                        null == p && (p = l.length - 1, k.setTerminalPoint(new mxPoint(l[p].x / f - g.x, l[p].y / f - g.y), !1));
                        k = k.points;
                        if (null != k) for (l = 0; l < k.length; l++) k[l].x += n,
                        k[l].y += m
                    } else k.translate(n, m)
                }
            }
        } else c = []
    }
...
mxGraph.prototype.cellsAdded = function(a, b, c, d, e, f, g) {
    if (null != a && null != b && null != c) {
        this.model.beginUpdate();
        try {
            for (var k = f ? this.view.getState(b) : null, l = null != k ? k.origin: null, m = new mxPoint(0, 0), k = 0; k < a.length; k++) if (null == a[k]) c--;
            else {
                ...
                if (null != l && a[k] != b && b != n) {
                    ...
                    if (null != r) {
                        ...
                        t = q.y - l.y,
                        r = r.clone();
                        r.translate(s, t); ! r.relative && (this.model.isVertex(a[k]) && !this.isAllowNegativeCoordinates()) && (r.x = Math.max(0, r.x), r.y = Math.max(0, r.y));
                ...
                this.isExtendParentsOnAdd() && this.isExtendParent(a[k]) && this.extendParent(a[k]); (null == g || g) && this.constrainChild(a[k]);
    ...
    if (null != a && 0 < a.length) {
        ...
        try {
            ...
            for (e = 0; e < a.length; e++) {
                for (var g = this.getConnections(a[e]), k = 0; k < g.length; k++) if (f = mxCellPath.create(g[k]), null == d[f]) {
        ...
        try {
            ...
            if (null != c && null != d) {
                ...
                if (this.isSwimlane(a)) {
                    ...
                    null == k && (k = "");
                    mxUtils.getValue(g, mxConstants.STYLE_HORIZONTAL, !0) ? (k = mxUtils.setStyle(k, mxConstants.STYLE_STARTSIZE, c.height + 8), e && (d.height = c.height + 8), d.width = c.width) : (k = mxUtils.setStyle(k, mxConstants.STYLE_STARTSIZE, c.width + 8), e && (d.width = c.width + 8), d.height = c.height);
                    this.model.setStyle(a, k)
                } else d.width = c.width,
                d.height = c.height;
                if (!b && !e) {
...
mxGraph.prototype.getPreferredSizeForCell = function(a) {
    var b = null;
    if (null != a) {
        var c = this.view.getState(a) || this.view.createState(a),
        d = c.style;
        if (!this.model.isEdge(a)) {
            var e = d[mxConstants.STYLE_FONTSIZE] || mxConstants.DEFAULT_FONTSIZE;
            a = b = 0;
            if ((null != this.getImage(c) || null != d[mxConstants.STYLE_IMAGE]) && d[mxConstants.STYLE_SHAPE] == mxConstants.SHAPE_LABEL) d[mxConstants.STYLE_VERTICAL_ALIGN] == mxConstants.ALIGN_MIDDLE && (b += parseFloat(d[mxConstants.STYLE_IMAGE_WIDTH]) || mxLabel.prototype.imageSize),
            d[mxConstants.STYLE_ALIGN] != mxConstants.ALIGN_CENTER && (a += parseFloat(d[mxConstants.STYLE_IMAGE_HEIGHT]) || mxLabel.prototype.imageSize);
            b += 2 * (d[mxConstants.STYLE_SPACING] || 0);
            b += d[mxConstants.STYLE_SPACING_LEFT] || 0;
            b += d[mxConstants.STYLE_SPACING_RIGHT] || 0;
            a += 2 * (d[mxConstants.STYLE_SPACING] || 0);
            a += d[mxConstants.STYLE_SPACING_TOP] || 0;
            a += d[mxConstants.STYLE_SPACING_BOTTOM] || 0;
            var f = this.getFoldingImage(c);
            null != f && (b += f.width + 8);
            f = this.cellRenderer.getLabelValue(c);
            null != f && 0 < f.length ? (this.isHtmlLabel(c.cell) || (f = mxUtils.htmlEntities(f)), f = f.replace(/\n/g, "<br>"), e = mxUtils.getSizeForString(f, e, d[mxConstants.STYLE_FONTFAMILY]), c = e.width + b, a = e.height + a, mxUtils.getValue(d, mxConstants.STYLE_HORIZONTAL, !0) || (d = a, a = c, c = d), this.gridEnabled && (c = this.snap(c + this.gridSize / 2), a = this.snap(a + this.gridSize / 2)), b = new mxRectangle(0, 0, c, a)) : (d = 4 * this.gridSize, b = new mxRectangle(0, 0, d, d))
        }
    }
    return b
};
...
mxGraph.prototype.cellsResized = function(a, b, c) {
    ...
    if (null != a && null != b && a.length == b.length) {
        this.model.beginUpdate();
        try {
            for (var d = 0; d < a.length; d++) this.cellResized(a[d], b[d], !1, c),
            this.isExtendParent(a[d]) ? this.extendParent(a[d]) : this.isConstrainChildrenOnResize() && this.constrainChild(a[d]);
...
mxGraph.prototype.cellResized = function(a, b, c, d) {
    ...
    if (null != e && (e.x != b.x || e.y != b.y || e.width != b.width || e.height != b.height)) {
        e = e.clone(); ! c && e.relative ? (c = e.offset, null != c && (c.x += b.x - e.x, c.y += b.y - e.y)) : (e.x = b.x, e.y = b.y);
        e.width = b.width;
        e.height = b.height; ! e.relative && (this.model.isVertex(a) && !this.isAllowNegativeCoordinates()) && (e.x = Math.max(0, e.x), e.y = Math.max(0, e.y));
        this.model.beginUpdate();
        try {
            d && this.resizeChildCells(a, e),
            this.model.setGeometry(a, e),
            this.isConstrainChildrenOnResize() && this.constrainChildCells(a)
        } finally {
            this.model.endUpdate()
        }
    }
...
mxGraph.prototype.scaleCell = function(a, b, c, d) {
    var e = this.model.getGeometry(a);
    null != e && (this.isCellMovable(a) && this.isCellResizable(a)) && (e = e.clone(), e.scale(b, c), this.model.isVertex(a) ? this.cellResized(a, e, !0, d) : this.model.setGeometry(a, e))
};
mxGraph.prototype.extendParent = function(a) {
    if (null != a) {
        var b = this.model.getParent(a),
        c = this.model.getGeometry(b);
        if (null != b && (null != c && !this.isCellCollapsed(b)) && (a = this.model.getGeometry(a), null != a && (c.width < a.x + a.width || c.height < a.y + a.height))) c = c.clone(),
...
mxGraph.prototype.cellsMoved = function(a, b, c, d, e, f) {
    if (null != a && (0 != b || 0 != c)) {
        ...
        try {
            ...
            for (var g = 0; g < a.length; g++) this.translateCell(a[g], b, c),
...
mxGraph.prototype.translateCell = function(a, b, c) {
    ...
    if (null != d) {
        ...
        c = parseFloat(c);
        d = d.clone();
        d.translate(b, c); ! d.relative && (this.model.isVertex(a) && !this.isAllowNegativeCoordinates()) && (d.x = Math.max(0, parseFloat(d.x)), d.y = Math.max(0, parseFloat(d.y)));
        if (d.relative && !this.model.isEdge(a)) {
            var e = this.model.getParent(a),
            f = 0;
            this.model.isVertex(e) && (f = this.view.getState(e), e = null != f ? f.style: this.getCellStyle(e), f = mxUtils.getValue(e, mxConstants.STYLE_ROTATION, 0));
        ...
        if (null != b && b != this.getDefaultParent()) {
            ...
            if (null != c) {
                ...
                if (this.isSwimlane(b)) {
                    ...
                    g = this.view.getState(b),
                    k = null != g ? g.style: this.getCellStyle(b),
                    b = mxUtils.getValue(k, mxConstants.STYLE_DIRECTION, mxConstants.DIRECTION_EAST),
                    g = 1 == mxUtils.getValue(k, mxConstants.STYLE_FLIPH, 0),
                    k = 1 == mxUtils.getValue(k, mxConstants.STYLE_FLIPV, 0);
                    if (b == mxConstants.DIRECTION_SOUTH || b == mxConstants.DIRECTION_NORTH) {
                        var l = f.width;
                        f.width = f.height;
                        f.height = l
                    }
                    if (b == mxConstants.DIRECTION_EAST && !k || b == mxConstants.DIRECTION_NORTH && !g || b == mxConstants.DIRECTION_WEST && k || b == mxConstants.DIRECTION_SOUTH && g) a = f.width,
                    d = f.height;
                    e -= f.width;
                    c -= f.height
                }
        ...
        try {
            for (c = 0; c < a.length; c++) {
                ...
                if (null != e) for (d = 0; d < e.length; d++) {
                    ...
                    m = mxCellPath.create(k); (null == b[l] || null == b[m]) && this.resetEdge(e[d])
                }
...
mxGraph.prototype.getOutlineConstraint = function(a, b, c) {
    if (null != b.shape) {
        ...
        if (this.getModel().isVertex(b.cell)) {
            ...
            if (d == mxConstants.DIRECTION_NORTH || d == mxConstants.DIRECTION_SOUTH) e = m,
            m = n,
            n = e;
            m && (f = -1, k = -c.width);
            n && (g = -1, l = -c.height)
...
mxGraph.prototype.getConnectionPoint = function(a, b) {
    ...
    if (null != a) {
        ...
        b.perimeter ? (0 != g && null != c && (k = d = 0, 90 == g ? k = 1 : 180 == g ? d = -1 : 270 == f && (k = -1), c = mxUtils.getRotatedPoint(c, d, k, e)), null != c && b.perimeter && (c = this.view.getPerimeterPoint(a, c, !1))) : f += g;
                ...
                if (null != g) {
                    ...
                    if (null != k && null != l) {
                        ...
                        if (null != q && this.isCellDisconnectable(a[e], q, !0)) {
                            for (var r = mxCellPath.create(q); null != q && null == d[r];) q = this.model.getParent(q),
                            r = mxCellPath.create(q);
                        ...
                        if (null != s && this.isCellDisconnectable(a[e], s, !1)) {
                            for (var t = mxCellPath.create(s); null != s && null == d[t];) s = this.model.getParent(s),
                            t = mxCellPath.create(s);
                            if (null == s) {
                                var u = p.length - 1;
                                g.setTerminalPoint(new mxPoint(p[u].x / b - c.x + m, p[u].y / b - c.y + n), !1);
...
mxGraph.prototype.getBoundingBoxFromGeometry = function(a, b) {
    ...
    if (null != a) for (var d = 0; d < a.length; d++) if (b || this.model.isVertex(a[d])) {
        ...
        if (null != e) {
            ...
            null != g && (null == c ? c = new mxRectangle(g.x, g.y, g.width, g.height) : c.add(g))
        }
    }
    return c
};
    ...
    this.container.scrollTop = -b;
        ...
        if (this.dialect == mxConstants.DIALECT_SVG) if (0 == a && 0 == b) {
            if (mxClient.IS_IE ? c.setAttribute("transform", "translate(" + a + "," + b + ")") : c.removeAttribute("transform"), null != this.shiftPreview1) {
                ...
                for (d = this.shiftPreview2.firstChild; null != d;) e = d.nextSibling,
                this.container.appendChild(d),
                d = e;
            ...
            if (null == this.shiftPreview1) {
                ...
                d = this.container.firstChild; null != d;) e = d.nextSibling,
...
mxGraph.prototype.zoom = function(a, b) {
    ...
    this.view.scale = c,
    this.scrollRectToVisible(d) || (this.view.revalidate(), this.view.setScale(c));
...
mxGraph.prototype.scrollRectToVisible = function(a) {
    ...
    if (null != a) {
        ...
        if (mxUtils.hasScrollbars(this.container)) {
            ...
            0 < e ? c.scrollTop -= e + 2 : (e = a.y + f - c.scrollTop - c.clientHeight, 0 < e && (c.scrollTop += e + 2)); ! this.useScrollbarsForPanning && (0 != d || 0 != g) && this.view.setTranslate(d, g)
        } else {
...
mxGraph.prototype.validateGraph = function(a, b) {
    ...
    b = null != b ? b: {};
    for (var c = !0,
    d = this.model.getChildCount(a), e = 0; e < d; e++) {
...
mxGraph.prototype.getTooltip = function(a, b, c, d) {
    var e = null;
    if (null != a) {
        if (null != a.control && (b == a.control.node || b.parentNode == a.control.node)) e = this.collapseExpandResource,
...
mxGraph.prototype.getDropTarget = function(a, b, c, d) {
    ...
    return ! this.model.isLayer(c) && null == g ? c: null
};
...
mxGraph.prototype.getEdges = function(a, b, c, d, e, f) {
    ...
    k = [];
    for (m = 0; m < g.length; m++) n = this.view.getState(g[m]),
    l = null != n ? n.getVisibleTerminal(!0) : this.view.getVisibleTerminal(g[m], !0),
    n = null != n ? n.getVisibleTerminal(!1) : this.view.getVisibleTerminal(g[m], !1),
    (e && l == n || l != n && (c && n == a && (null == b || this.isValidAncestor(l, b, f)) || d && l == a && (null == b || this.isValidAncestor(n, b, f)))) && k.push(g[m]);
    return k
};
...
mxGraph.prototype.getEdgesBetween = function(a, b, c) {
    ...
    for (var d = this.getEdges(a), e = [], f = 0; f < d.length; f++) {
        ...
        g = null != g ? g.getVisibleTerminal(!1) : this.view.getVisibleTerminal(d[f], !1); (k == a && g == b || !c && k == b && g == a) && e.push(d[f])
    }
    return e
};
    ...
    if (null != a) {
        for (var e = this.getModel(), f = e.getChildCount(a), g = null, k = 0, l = 0; l < f; l++) {
            ...
            if (this.model.isVertex(m) && this.isCellVisible(m)) {
                for (var n = this.getConnections(m, b ? a: null), p = 0, q = 0, r = 0; r < n.length; r++) this.view.getVisibleTerminal(n[r], !0) == m ? p++:q++; (c && 0 == p && 0 < q || !c && 0 == q && 0 < p) && d.push(m);
                n = c ? q - p: p - q;
                n > k && (k = n, g = m)
            }
        }
...
mxGraph.prototype.traverse = function(a, b, c, d, e) {
    if (null != c && null != a) {
        ...
        if (null == e[f] && (e[f] = a, d = c(a, d), null == d || d)) if (d = this.model.getEdgeCount(a), 0 < d) for (f = 0; f < d; f++) {
            ...
            if (!b || k) k = this.model.getTerminal(g, !k),
            this.traverse(k, b, c, g, e)
        }
    }
};
...
mxGraph.prototype.isEventIgnored = function(a, b, c) {
    ...
    else if (a == mxEvent.MOUSE_DOWN && !this.isMouseDown) this.isMouseDown = !0,
    this.isMouseTrigger = d;
    else if (!e && ((!mxClient.IS_FF || a != mxEvent.MOUSE_MOVE) && this.isMouseDown && this.isMouseTrigger != d || a == mxEvent.MOUSE_DOWN && this.isMouseDown || a == mxEvent.MOUSE_UP && !this.isMouseDown)) e = !0; ! e && a == mxEvent.MOUSE_DOWN && (this.lastMouseX = b.getX(), this.lastMouseY = b.getY());
    return e
};
...
mxGraph.prototype.fireMouseEvent = function(a, b, c) {
    if (this.isEventSourceIgnored(a, b)) null != this.tooltipHandler && this.tooltipHandler.hide();
        ...
        if (!this.nativeDblClickEnabled && !mxEvent.isPopupTrigger(b.getEvent()) || this.doubleTapEnabled && mxClient.IS_TOUCH && mxEvent.isTouchEvent(b.getEvent())) {
            ...
            if (!mxClient.IS_QUIRKS && a == mxEvent.MOUSE_DOWN || mxClient.IS_QUIRKS && a == mxEvent.MOUSE_UP && !this.fireDoubleClick) if (null != this.lastTouchEvent && this.lastTouchEvent != b.getEvent() && d - this.lastTouchTime < this.doubleTapTimeout && Math.abs(this.lastTouchX - b.getX()) < this.doubleTapTolerance && Math.abs(this.lastTouchY - b.getY()) < this.doubleTapTolerance && 2 > this.doubleClickCounter) {
                if (this.doubleClickCounter++, d = !1, a == mxEvent.MOUSE_UP ? b.getCell() == this.lastTouchCell && null != this.lastTouchCell && (this.lastTouchTime = 0, d = this.lastTouchCell, this.lastTouchCell = null, this.dblClick(b.getEvent(), d), d = !0) : (this.fireDoubleClick = !0, this.lastTouchTime = 0), !mxClient.IS_QUIRKS || d) {
                    mxEvent.consume(b.getEvent());
                    return
                }
            } else {
                if (null == this.lastTouchEvent || this.lastTouchEvent != b.getEvent()) this.lastTouchCell = b.getCell(),
                ...
                this.isMouseDown = !1; (null != d || mxEvent.isTouchEvent(b.getEvent()) && (mxClient.IS_GC || mxClient.IS_SF)) && Math.abs(this.lastTouchX - b.getX()) < this.doubleTapTolerance && Math.abs(this.lastTouchY - b.getY()) < this.doubleTapTolerance ? this.dblClick(b.getEvent(), d) : mxEvent.consume(b.getEvent());
                return
            }
        }
        if (!this.isEventIgnored(a, b, c)) {
            this.fireEvent(new mxEventObject(mxEvent.FIRE_MOUSE_EVENT, "eventName", a, "event", b));
            if (mxClient.IS_OP || mxClient.IS_SF || mxClient.IS_GC || mxClient.IS_IE && mxClient.IS_SVG || b.getEvent().target != this.container) {
...
mxCellOverlay.prototype.getBounds = function(a) {
    ...
    e = this.image.width,
    f = this.image.height;
    b ? (b = a.absolutePoints, 1 == b.length % 2 ? d = b[Math.floor(b.length / 2)] : (d = b.length / 2, a = b[d - 1], b = b[d], d = new mxPoint(a.x + (b.x - a.x) / 2, a.y + (b.y - a.y) / 2))) : (d = new mxPoint, d.x = this.align == mxConstants.ALIGN_LEFT ? a.x: this.align == mxConstants.ALIGN_CENTER ? a.x + a.width / 2 : a.x + a.width, d.y = this.verticalAlign == mxConstants.ALIGN_TOP ? a.y: this.verticalAlign == mxConstants.ALIGN_MIDDLE ? a.y + a.height / 2 : a.y + a.height);
...
mxOutline.prototype.init = function(a) {
    ...
    function(a) { ! this.suspended && null != this.outline && b.apply(this.outline, arguments)
    });
    ...
    function(a, b) { ! this.suspended && !this.active && this.update()
    });
...
mxOutline.prototype.update = function(a) {
    if (null != this.source && null != this.outline) {
        ...
        if (0 < e) {
            ...
            0 > c.x && (f -= c.x);
            0 > c.y && (g -= c.y);
            if (d.translate.x != f || d.translate.y != g) d.translate.x = f,
            d.translate.y = g,
            a = !0;
            var c = d.translate,
            ...
            if (c.x != this.bounds.x || c.y != this.bounds.y || c.width != this.bounds.width || c.height != this.bounds.height) this.selectionBorder.bounds = this.bounds,
            ...
            if (c.x != d.x || c.y != d.y || c.width != d.width || c.height != d.height) this.sizer.bounds = d,
...
mxOutline.prototype.mouseDown = function(a, b) {
    if (this.enabled && this.showViewport) {
        ...
        this.startY = b.getY();
        this.active = !0;
        this.source.useScrollbarsForPanning && mxUtils.hasScrollbars(this.source.container) ? (this.dx0 = this.source.container.scrollLeft, this.dy0 = this.source.container.scrollTop) : this.dy0 = this.dx0 = 0
    }
    b.consume()
};
mxOutline.prototype.mouseMove = function(a, b) {
    if (this.active) {
        ...
        e = c.y,
        c = null;
        if (this.zoom) c = this.source.container,
        e = d / (c.clientWidth / c.clientHeight),
...
mxOutline.prototype.mouseUp = function(a, b) {
    if (this.active) {
        ...
        if (0 < Math.abs(d) || 0 < Math.abs(c)) {
            ...
            } else if (!this.source.useScrollbarsForPanning || !mxUtils.hasScrollbars(this.source.container)) this.source.panGraph(0, 0),
            d /= this.outline.getView().scale,
...
mxMultiplicity.prototype.checkNeighbors = function(a, b, c, d) {
    ...
    for (var e = this.validNeighbors,
    f = 0; f < e.length; f++) if (this.source && this.checkType(a, d, e[f])) {
        c = this.validNeighborsAllowed;
        break
...
mxLayoutManager.prototype.layoutCells = function(a) {
    if (0 < a.length) {
        ...
        try {
            for (var c = null,
            d = 0; d < a.length; d++) a[d] != b.getRoot() && a[d] != c && (c = a[d], this.executeLayout(this.getLayout(c), c));
...
mxSpaceManager.prototype.shiftCell = function(a, b, c, d, e, f, g, k, l, m) {
    ...
    if (null != n) {
        ...
        if (null != q) {
            p.beginUpdate();
            try {
                if (this.isShiftRightwards()) if (n.x >= f) q = q.clone(),
                q.translate( - b, 0);
                else {
                ...
                if (this.isShiftDownwards()) if (n.y >= g) q = q.clone(),
                q.translate(0, -c);
                else {
...
mxSwimlaneManager.prototype.resizeSwimlane = function(a, b, c, d) {
    ...
    try {
        ...
        if (!this.isSwimlaneIgnored(a)) {
            ...
            if (null != g && (d && g.height != c || !d && g.width != b)) g = g.clone(),
            d ? g.height = c: g.width = b,
            e.setGeometry(a, g)
        }
...
mxCellStatePreview.prototype.show = function(a) {
    this.deltas.visit(mxUtils.bind(this,
    function(a, c) {
...
mxCellStatePreview.prototype.translateState = function(a, b, c) {
    if (null != a) {
        ...
        if (d.isVertex(a.cell)) {
            ...
            if ((0 != b || 0 != c) && null != e && (!e.relative || null != this.deltas.get(a.cell))) a.x += b,
            a.y += c
        }
...
mxCellStatePreview.prototype.revalidateState = function(a, b, c, d) {
    if (null != a) {
        ...
        if ((0 != b || 0 != c) && null != f && f.relative && e.isVertex(a.cell) && (null == g || e.isVertex(g.cell) || null != this.deltas.get(a.cell))) a.x += b,
        a.y += c;
...
function mxGraphHandler(a) {
    ...
    this.escapeHandler = mxUtils.bind(this,
    function(a, c) {
        this.reset()
    });
...
mxGraphHandler.prototype.mouseMove = function(a, b) {
    var c = this.graph;
    if (!b.isConsumed() && c.isMouseDown && null != this.cell && null != this.first && null != this.bounds) if (mxEvent.isMultiTouchEvent(b.getEvent())) this.reset();
    else {
        ...
        if (null != this.shape || Math.abs(e) > f || Math.abs(d) > f) {
            ...
            f = !0;
            if (null != this.guide && this.useGuidesForEvent(b)) d = this.guide.move(this.bounds, new mxPoint(e, d), g),
            f = !1,
            e = d.x,
            d = d.y;
            ...
            c.isDropEnabled() && this.highlightEnabled && (f = c.getDropTarget(this.cells, b.getEvent(), d, g));
            e = c.getView().getState(f);
            k = !1;
            null != e && (c.model.getParent(this.cell) != f || g) ? (this.target != f && (this.target = f, this.setHighlightColor(mxConstants.DROP_TARGET_COLOR)), k = !0) : (this.target = null, this.connectOnDrop && (null != d && 1 == this.cells.length && c.getModel().isVertex(d) && c.isCellConnectable(d)) && (e = c.getView().getState(d), null != e && (c = null == c.getEdgeValidationError(null, this.cell, d) ? mxConstants.VALID_COLOR: mxConstants.INVALID_CONNECT_TARGET_COLOR, this.setHighlightColor(c), k = !0)));
            null != e && k ? this.highlight.highlight(e) : this.highlight.hide()
        }
        this.updateHint(b);
        b.consume();
        mxEvent.consume(b.getEvent())
    } else if ((this.isMoveEnabled() || this.isCloneEnabled()) && this.updateCursor && !b.isConsumed() && null != b.getState() && !c.isMouseDown) e = c.getCursorForMouseEvent(b),
...
function mxPanningHandler(a) {
    null != a && (this.graph = a, this.graph.addMouseListener(this), this.forcePanningHandler = mxUtils.bind(this,
    function(a, c) {
    ...
    }), this.graph.addListener(mxEvent.FIRE_MOUSE_EVENT, this.forcePanningHandler), this.gestureHandler = mxUtils.bind(this,
    function(a, c) {
        if (this.isPinchEnabled()) {
            var d = c.getProperty("event"); ! mxEvent.isConsumed(d) && "gesturestart" == d.type ? (this.initialScale = this.graph.view.scale, !this.active && null != this.mouseDownEvent && (this.start(this.mouseDownEvent), this.mouseDownEvent = null)) : "gestureend" == d.type && null == this.initialScale && (this.initialScale = null);
            if (null != this.initialScale) {
                ...
                this.graph.view.scale != e && (this.graph.zoomTo(e), mxEvent.consume(d))
            }
        }
...
mxPanningHandler.prototype.mouseDown = function(a, b) {
    this.mouseDownEvent = b; ! b.isConsumed() && (this.isPanningEnabled() && !this.active && this.isPanningTrigger(b)) && (this.start(b), this.consumePanningTrigger(b))
};
...
mxPanningHandler.prototype.mouseMove = function(a, b) {
    ...
    if (this.active) this.previewEnabled && (this.useGrid && (this.dx = this.graph.snap(this.dx), this.dy = this.graph.snap(this.dy)), this.graph.panGraph(this.dx + this.dx0, this.dy + this.dy0)),
    this.fireEvent(new mxEventObject(mxEvent.PAN, "event", b));
    else if (this.panningTrigger) {
        var c = this.active;
        this.active = Math.abs(this.dx) > this.graph.tolerance || Math.abs(this.dy) > this.graph.tolerance; ! c && this.active && this.fireEvent(new mxEventObject(mxEvent.PAN_START, "event", b))
...
function mxPopupMenuHandler(a, b) {
    null != a && (this.graph = a, this.factoryMethod = b, this.graph.addMouseListener(this), this.gestureHandler = mxUtils.bind(this,
    function(a, b) {
        this.inTolerance = !1
...
mxPopupMenuHandler.prototype.init = function() {
    ...
    mxEvent.addGestureListeners(this.div, mxUtils.bind(this,
    function(a) {
...
mxCellMarker.prototype.setCurrentState = function(a, b, c) {
    ...
    if (a != this.markedState || c != this.currentColor) this.currentColor = c,
    null != a && null != this.currentColor ? (this.markedState = a, this.mark()) : null != this.markedState && (this.markedState = null, this.unmark())
};
...
function mxConnectionHandler(a, b) {
    mxEventSource.call(this);
    null != a && (this.graph = a, this.factoryMethod = b, this.init(), this.escapeHandler = mxUtils.bind(this,
    function(a, b) {
        this.reset()
    }), this.graph.addListener(mxEvent.ESCAPE, this.escapeHandler))
}
...
mxConnectionHandler.prototype.updateCurrentState = function(a, b) {
    ...
    if (null != this.constraintHandler.currentFocus && null != this.constraintHandler.currentConstraint) this.marker.reset(),
...
mxConnectionHandler.prototype.mouseMove = function(a, b) {
    if (!b.isConsumed() && (this.ignoreMouseDown || null != this.first || !this.graph.isMouseDown)) { ! this.isEnabled() && null != this.currentState && (this.destroyIcons(), this.currentState = null);
        ...
        this.currentPoint = c; (null != this.first || this.isEnabled() && this.graph.isEnabled()) && this.updateCurrentState(b, c);
        if (null != this.first) {
            var f = null,
            d = c;
            ...
            if (null != this.edgeState) {
                ...
                if (null != this.waypoints) {
                    e = [];
                    for (d = 0; d < this.waypoints.length; d++) f = this.waypoints[d].clone(),
                    this.convertWaypoint(f),
                    e[d] = f
                }
            ...
            } else null != this.currentState && null == this.constraintHandler.currentConstraint && (g = this.getTargetPerimeterPoint(this.currentState, b), null != g && (d = g)),
            null == this.sourceConstraint && null != this.previous && (g = this.getSourcePerimeterPoint(this.previous, null != this.waypoints && 0 < this.waypoints.length ? this.waypoints[0] : d, b), null != g && (e = g));
...
mxConnectionHandler.prototype.addWaypointForEvent = function(a) {
    ...
    if (null != this.waypoints || 1 < this.mouseDownCounter && (c > this.graph.tolerance || b > this.graph.tolerance)) null == this.waypoints && (this.waypoints = []),
        ...
        try {
            ...
            if (null != g) {
                ...
                if (null == b) {
                    ...
                    r = new mxPoint(this.currentPoint.x / p - s.x, this.currentPoint.y / p - s.y);
    ...
    if (this.isEnabled() && !this.isEventIgnored(a)) {
        ...
        if (null == this.currentFocusArea || !mxUtils.intersects(this.currentFocusArea, d) || null != a.getState() && null != this.currentFocus && e) if (this.currentFocusArea = null, a.getState() != this.currentFocus) if (this.currentFocus = null, this.constraints = null != a.getState() && e && !this.isStateIgnored(a.getState(), b) ? this.graph.getAllConnectionConstraints(a.getState(), b) : null, null != this.constraints) {
            ...
            for (e = 0; e < this.constraints.length; e++) {
                ...
                g.init(this.graph.getView().getDecoratorPane()); (mxClient.IS_QUIRKS || 8 == document.documentMode) && mxEvent.addListener(g.node, "dragstart",
                function(a) {
                    mxEvent.consume(a);
                    return ! 1
                });
        ...
        } else this.destroyIcons(),
        this.destroyFocusHighlight();
        this.currentPoint = this.currentConstraint = null;
        if (null != this.focusIcons && null != this.constraints && (null == a.getState() || this.currentFocus == a.getState())) for (e = 0; e < this.focusIcons.length; e++) if (mxUtils.intersects(this.focusIcons[e].bounds, d)) {
            ...
            null == this.focusHighlight ? (c = new mxRectangleShape(c, null, this.highlightColor, 3), c.pointerEvents = !1, c.dialect = this.graph.dialect == mxConstants.DIALECT_SVG ? mxConstants.DIALECT_SVG: mxConstants.DIALECT_VML, c.init(this.graph.getView().getOverlayPane()), this.focusHighlight = c, k = mxUtils.bind(this,
            function() {
                return null != this.currentFocus ? this.currentFocus: a.getState()
...
function mxRubberband(a) {
    null != a && (this.graph = a, this.graph.addMouseListener(this), this.forceRubberbandHandler = mxUtils.bind(this,
    function(a, c) {
        var d = c.getProperty("eventName"),
        e = c.getProperty("event");
    ...
    }), this.graph.addListener(mxEvent.FIRE_MOUSE_EVENT, this.forceRubberbandHandler), this.panHandler = mxUtils.bind(this,
    function() {
        this.repaint()
    }), this.graph.addListener(mxEvent.PAN, this.panHandler), this.gestureHandler = mxUtils.bind(this,
    function(a, c) {
        null != this.first && this.reset()
    }), this.graph.addListener(mxEvent.GESTURE, this.gestureHandler), mxClient.IS_IE && mxEvent.addListener(window, "unload", mxUtils.bind(this,
    function() {
        this.destroy()
    })))
}
...
mxRubberband.prototype.mouseMove = function(a, b) {
    if (!b.isConsumed() && null != this.first) {
        ...
        if (null != this.div || Math.abs(e) > g || Math.abs(f) > g) null == this.div && (this.div = this.createShape()),
...
mxHandle.prototype.processEvent = function(a) {
    ...
    b = new mxPoint(a.getGraphX() / b - c.x, a.getGraphY() / b - c.y),
    c = -mxUtils.toRadians(this.getRotation()),
    d = -mxUtils.toRadians(this.getTotalRotation()) - c,
    b = this.flipPoint(this.rotatePoint(this.snapPoint(this.rotatePoint(b, c), this.ignoreGrid || !this.graph.isGridEnabledEvent(a.getEvent())), d));
    this.setPosition(this.state.getPaintBounds(), b, a);
...
mxHandle.prototype.init = function() {
    ...
    null != this.image ? (this.shape = new mxImageShape(new mxRectangle(0, 0, this.image.width, this.image.height), this.image.src), this.shape.preserveImageAspect = !1) : this.shape = this.createShape(a);
    this.initShape(a)
};
...
mxHandle.prototype.redraw = function() {
    if (null != this.shape && null != this.state.shape) {
        ...
        if (null != a) {
            ...
            c = this.graph.view.translate;
            this.shape.bounds.x = Math.round((a.x + c.x) * b - this.shape.bounds.width / 2);
            this.shape.bounds.y = Math.round((a.y + c.y) * b - this.shape.bounds.height / 2);
            this.shape.redraw()
        }
    }
};
...
mxHandle.prototype.rotatePoint = function(a, b) {
    ...
    d = Math.cos(b),
    e = Math.sin(b);
    return mxUtils.getRotatedPoint(a, d, e, c)
};
...
function mxVertexHandler(a) {
    null != a && (this.state = a, this.init(), this.escapeHandler = mxUtils.bind(this,
    function(a, c) {
...
mxVertexHandler.prototype.init = function() {
    ...
    if (this.graph.isEnabled() && this.rotationEnabled && this.graph.isCellRotatable(this.state.cell) && (0 >= mxGraphHandler.prototype.maxCells || this.graph.getSelectionCount() < mxGraphHandler.prototype.maxCells) && 2 < this.state.width && 2 < this.state.height) this.rotationShape = this.createSizer(this.rotationCursor, mxEvent.ROTATION_HANDLE, mxConstants.HANDLE_SIZE + 3, mxConstants.HANDLE_FILLCOLOR),
...
mxVertexHandler.prototype.getHandleForEvent = function(a) {
    ...
    e = null;
    if (null != this.customHandles) for (c = 0; c < this.customHandles.length; c++) if (b(this.customHandles[c].shape)) return mxEvent.CUSTOM_HANDLE - c;
...
mxVertexHandler.prototype.mouseDown = function(a, b) {
    ...
    if (!b.isConsumed() && this.graph.isEnabled() && (0 < c || b.getState() == this.state)) c = this.getHandleForEvent(b),
...
mxVertexHandler.prototype.start = function(a, b, c) {
    ...
    if (this.state.view.currentRoot != b && (a.isVertex(b) || a.isEdge(b))) this.parentState = this.state.view.graph.view.getState(b);
    this.selectionBorder.node.style.display = c == mxEvent.ROTATION_HANDLE ? "inline": "none";
    if (!this.livePreview || this.isLivePreviewBorder()) this.preview = this.createSelectionShape(this.bounds),
    ...
    if (this.livePreview) {
        this.hideSizers();
        c == mxEvent.ROTATION_HANDLE ? this.rotationShape.node.style.display = "": null != this.sizers && null != this.sizers[c] ? this.sizers[c].node.style.display = "": c <= mxEvent.CUSTOM_HANDLE && null != this.customHandles && this.customHandles[mxEvent.CUSTOM_HANDLE - c].setVisible(!0);
        c = this.graph.getEdges(this.state.cell);
        this.edgeHandlers = [];
        for (a = 0; a < c.length; a++) b = this.graph.selectionCellsHandler.getHandler(c[a]),
        null != b && this.edgeHandlers.push(b)
    }
};
mxVertexHandler.prototype.hideSizers = function() {
    if (null != this.sizers) for (var a = 0; a < this.sizers.length; a++) this.sizers[a].node.style.display = "none";
    if (null != this.customHandles) for (a = 0; a < this.customHandles.length; a++) this.customHandles[a].setVisible(!1)
};
...
mxVertexHandler.prototype.mouseMove = function(a, b) {
    if (!b.isConsumed() && null != this.index) {
        ...
        if (!this.inTolerance) {
            ...
            if (this.index <= mxEvent.CUSTOM_HANDLE) null != this.customHandles && this.customHandles[mxEvent.CUSTOM_HANDLE - this.index].processEvent(b);
            else if (this.index == mxEvent.LABEL_HANDLE) d && (c.x = (this.graph.snap(c.x / e - f.x) + f.x) * e, c.y = (this.graph.snap(c.y / e - f.y) + f.y) * e),
            this.moveSizerTo(this.sizers[this.sizers.length - 1], c.x, c.y);
                ...
                this.bounds = new mxRectangle((null != this.parentState ? this.parentState.x: f.x * e) + this.unscaledBounds.x * e, (null != this.parentState ? this.parentState.y: f.y * e) + this.unscaledBounds.y * e, this.unscaledBounds.width * e, this.unscaledBounds.height * e);
                m.relative && null != this.parentState && (this.bounds.x += this.state.x - this.parentState.x, this.bounds.y += this.state.y - this.parentState.y);
                m = Math.cos(l);
                n = Math.sin(l);
                ...
                this.unscaledBounds.height = this.roundLength(this.unscaledBounds.height); ! this.graph.isCellCollapsed(this.state.cell) && (0 != p || 0 != g) ? (this.childOffsetX = this.state.x - this.bounds.x + k, this.childOffsetY = this.state.y - this.bounds.y + m) : this.childOffsetY = this.childOffsetX = 0;
                this.livePreview && (n = new mxRectangle(this.state.x, this.state.y, this.state.width, this.state.height), g = this.state.origin, this.state.x = this.bounds.x, this.state.y = this.bounds.y, this.state.origin = new mxPoint(this.state.x / e - f.x, this.state.y / e - f.y), this.state.width = this.bounds.width, this.state.height = this.bounds.height, e = this.state.absoluteOffset, e = new mxPoint(e.x, e.y), this.state.absoluteOffset.x = 0, this.state.absoluteOffset.y = 0, m = this.graph.getCellGeometry(this.state.cell), null != m && (f = m.offset || this.EMPTY_POINT, null != f && !m.relative && (this.state.absoluteOffset.x = this.state.view.scale * f.x, this.state.absoluteOffset.y = this.state.view.scale * f.y), this.state.view.updateVertexLabelOffset(this.state)), this.state.view.graph.cellRenderer.redraw(this.state, !0), this.state.view.invalidate(this.state.cell), this.state.invalid = !1, this.state.view.validate(), this.redrawHandles(), this.state.x = n.x, this.state.y = n.y, this.state.width = n.width, this.state.height = n.height, this.state.origin = g, this.state.absoluteOffset = e);
...
mxVertexHandler.prototype.mouseUp = function(a, b) {
    if (null != this.index && null != this.state) {
        ...
        this.graph.getModel().beginUpdate();
        try {
            if (this.index <= mxEvent.CUSTOM_HANDLE) null != this.customHandles && this.customHandles[mxEvent.CUSTOM_HANDLE - this.index].execute();
            else if (this.index == mxEvent.ROTATION_HANDLE) {
    ...
    if (0 != b) {
        ...
        if (d.isVertex(a) || d.isEdge(a)) {
            if (!d.isEdge(a)) {
                ...
                e = null != e ? e.style: this.graph.getCellStyle(a);
                null != e && this.graph.setCellStyles(mxConstants.STYLE_ROTATION, (e[mxConstants.STYLE_ROTATION] || 0) + b, [a])
            }
            ...
            if (null != e) {
                ...
                if (d.isVertex(a) && !e.relative || d.isEdge(a)) {
                    c = d.getChildCount(a);
                    for (e = 0; e < c; e++) this.rotateCell(d.getChildAt(a, e), b, a)
                }
            }
        }
    }
...
mxVertexHandler.prototype.union = function(a, b, c, d, e, f, g, k) {
    if (this.singleSizer) return d = a.x + a.width + b,
    g = a.y + a.height + c,
    e && (d = this.graph.snap(d / f) * f, g = this.graph.snap(g / f) * f),
    f = new mxRectangle(a.x, a.y, 0, 0),
    f.add(new mxRectangle(d, g, 0, 0)),
    f;
    var l = a.x - g.x * f,
    m = l + a.width,
    n = a.y - g.y * f;
    ...
    if (0 == d || 3 == d || 5 == d) l += b,
    e && (l = this.graph.snap(l / f) * f);
    else if (2 == d || 4 == d || 7 == d) m += b,
    e && (m = this.graph.snap(m / f) * f);
    e = m - l;
    c = a - n;
...
mxVertexHandler.prototype.redrawHandles = function() {
    ...
    if (null != this.sizers) {
        if (null == this.index && this.manageSizers && 1 < this.sizers.length) {
            ...
            if (a.width < 2 * this.sizers[0].bounds.width - 2 + 3 * b || a.height < 2 * this.sizers[0].bounds.height - 2 + 3 * b) a = new mxRectangle(a.x, a.y, a.width, a.height),
            b /= 2,
            this.horizontalOffset = this.sizers[0].bounds.width + b,
            this.verticalOffset = this.sizers[0].bounds.height + b,
            a.x -= this.horizontalOffset / 2,
            a.width += this.horizontalOffset,
            a.y -= this.verticalOffset / 2,
            a.height += this.verticalOffset
        }
        var b = a.x + a.width,
        c = a.y + a.height;
    ...
    if (null != this.customHandles) for (a = 0; a < this.customHandles.length; a++) this.customHandles[a].redraw()
};
...
mxEdgeHandler.prototype.createMarker = function() {
    ...
    a.getCell = function(a) {
        ...
        if (d == b.state.cell || null == d) d = b.getCellAt(e.x, e.y),
        b.state.cell == d && (d = null);
...
mxEdgeHandler.prototype.createBends = function() {
    for (var a = this.state.cell,
    b = [], c = 0; c < this.abspoints.length; c++) if (this.isHandleVisible(c)) {
        var d = c == this.abspoints.length - 1;
        if ((d = 0 == c || d) || this.graph.isCellBendable(a)) {
            var e = this.createHandleShape(c);
            this.initBend(e);
            this.isHandleEnabled(c) && (e.node.style.cursor = mxConstants.CURSOR_BEND_HANDLE, mxEvent.redirectMouseEvents(e.node, this.graph, this.state), (mxClient.IS_QUIRKS || 8 == document.documentMode) && mxEvent.addListener(e.node, "dragstart",
            function(a) {
                mxEvent.consume(a);
                return ! 1
            }));
...
mxEdgeHandler.prototype.createHandleShape = function(a) {
    if (null != this.handleImage) return a = new mxImageShape(new mxRectangle(0, 0, this.handleImage.width, this.handleImage.height), this.handleImage.src),
...
mxEdgeHandler.prototype.getPreviewTerminalState = function(a) {
    ...
    if (null != this.constraintHandler.currentFocus && null != this.constraintHandler.currentConstraint) return this.marker.reset(),
...
mxEdgeHandler.prototype.getPreviewPoints = function(a) {
    ...
    a = new mxPoint(a.x, a.y); ! this.isSource && !this.isTarget ? (this.convertPoint(a, !1), null == b ? b = [a] : b[this.index - 1] = a) : this.graph.resetEdgesOnConnect && (b = null);
    return b
};
...
mxEdgeHandler.prototype.updatePreviewState = function(a, b, c, d) {
    ...
    null == l && (null != c && this.isOutlineConnectEvent(d) ? (l = this.graph.getOutlineConstraint(b, c, d), this.constraintHandler.currentConstraint = l, this.constraintHandler.currentFocus = c, this.constraintHandler.currentPoint = b) : l = new mxConnectionConstraint);
    ...
    this.isSource ? g = l: this.isTarget && (k = l); (!this.isSource || null != e) && a.view.updateFixedTerminalPoint(a, e, !0, g); (!this.isTarget || null != f) && a.view.updateFixedTerminalPoint(a, f, !1, k);
    if ((this.isSource || this.isTarget) && null == c) a.setAbsoluteTerminalPoint(b, this.isSource),
...
mxEdgeHandler.prototype.mouseMove = function(a, b) {
    if (null != this.index && null != this.marker) {
        ...
        if (this.isLabel) this.label.x = c.x,
        this.label.y = c.y;
        else {
...
mxEdgeHandler.prototype.mouseUp = function(a, b) {
    if (null != this.index && null != this.marker) {
        ...
        if (b.getX() != this.startX || b.getY() != this.startY) {
            var d = this.graph.isCloneEvent(b.getEvent()) && this.cloneEnabled && this.graph.isCellsCloneable();
            if (null != this.error) 0 < this.error.length && this.graph.validationAlert(this.error);
                ...
                null == e && this.marker.hasValidState() && (e = this.marker.validState.cell);
                if (null != e) c = this.connect(c, e, this.isSource, d, b);
                else if (this.graph.isAllowDanglingEdges()) {
                    e = this.abspoints[this.isSource ? 0 : this.abspoints.length - 1];
                    e.x = this.roundLength(e.x / this.graph.view.scale - this.graph.view.translate.x);
                    e.y = this.roundLength(e.y / this.graph.view.scale - this.graph.view.translate.y);
                    var f = this.graph.getView().getState(this.graph.getModel().getParent(c));
                    null != f && (e.x -= f.origin.x, e.y -= f.origin.y);
                    e.x -= this.graph.panDx / this.graph.view.scale;
                    e.y -= this.graph.panDy / this.graph.view.scale;
                    c = this.changeTerminalPoint(c, e, this.isSource, d)
                }
            } else this.active ? c = this.changePoints(c, this.points, d) : (this.graph.getView().invalidate(this.state.cell), this.graph.getView().revalidate(this.state.cell))
        }
...
mxEdgeHandler.prototype.moveLabel = function(a, b, c) {
    ...
    if (null != e) {
        ...
        if (e.relative) {
            ...
            if (null != g && null != k) {
                var l = g.y + (k.y - g.y) / 2;
                e.offset = new mxPoint(Math.round((b - (g.x + (k.x - g.x) / 2)) / f), Math.round((c - l) / f));
                e.x = 0;
                e.y = 0
            }
        }
...
mxEdgeHandler.prototype.connect = function(a, b, c, d, e) {
    ...
    try {
        if (d) {
            var g = this.graph.cloneCells([a])[0];
...
mxEdgeHandler.prototype.addPointAt = function(a, b, c) {
    ...
    if (null != d) {
        ...
        c = this.graph.view.scale;
        var e = new mxPoint(e.x * c, e.y * c),
        f = this.graph.model.getParent(this.state.cell);
...
mxEdgeHandler.prototype.redrawInnerBends = function(a, b) {
    for (var c = 1; c < this.bends.length - 1; c++) if (null != this.bends[c]) if (null != this.abspoints[c]) {
        ...
        this.manageLabelHandle ? this.checkLabelHandle(this.bends[c].bounds) : null == this.handleImage && (this.labelShape.visible && mxUtils.intersects(this.bends[c].bounds, this.labelShape.bounds)) && (w = mxConstants.HANDLE_SIZE + 3, h = mxConstants.HANDLE_SIZE + 3, this.bends[c].bounds = new mxRectangle(Math.round(d - w / 2), Math.round(e - h / 2), w, h));
        this.bends[c].redraw()
    } else this.bends[c].destroy(),
    this.bends[c] = null
};
...
mxElbowEdgeHandler.prototype.createVirtualBend = function() {
    ...
    b = mxUtils.bind(this,
    function(a) { ! mxEvent.isConsumed(a) && this.flipEnabled && (this.graph.flipEdge(this.state.cell, a), mxEvent.consume(a))
    });
...
mxElbowEdgeHandler.prototype.getTooltipForNode = function(a) {
    var b = null;
    if (null != this.bends && null != this.bends[1] && (a == this.bends[1].node || a.parentNode == this.bends[1].node)) b = this.doubleClickOrientationResource,
...
mxEdgeSegmentHandler.prototype.createBends = function() {
    ...
    if (this.graph.isCellBendable(this.state.cell)) {
        null == this.points && (this.points = []);
        for (var d = 0; d < c.length - 1; d++) b = this.createVirtualBend(),
        a.push(b),
        b.node.style.cursor = 0 == c[d].x - c[d + 1].x ? "col-resize": "row-resize",
        this.points.push(new mxPoint(0, 0)),
        mxClient.IS_TOUCH && b.node.setAttribute("pointer-events", "none")
    }
...
mxEdgeSegmentHandler.prototype.changePoints = function(a, b) {
    ...
    if (1 < c.length) for (var d = c[0], e = c[1], f = 2; f < c.length; f++) {
        var g = c[f];
        if ((Math.round(d.x) != Math.round(e.x) || Math.round(e.x) != Math.round(g.x)) && (Math.round(d.y) != Math.round(e.y) || Math.round(e.y) != Math.round(g.y))) d = e,
        e = e.clone(),
        this.convertPoint(e, !1),
        b.push(e);
        e = g
    }
...
function mxKeyHandler(a, b) {
    null != a && (this.graph = a, this.target = b || document.documentElement, this.normalKeys = [], this.shiftKeys = [], this.controlKeys = [], this.controlShiftKeys = [], this.keydownHandler = mxUtils.bind(this,
    function(a) {
        this.keyDown(a)
    }), mxEvent.addListener(this.target, "keydown", this.keydownHandler), mxClient.IS_IE && mxEvent.addListener(window, "unload", mxUtils.bind(this,
    function() {
        this.destroy()
    })))
}
...
mxKeyHandler.prototype.keyDown = function(a) {
    if (this.graph.isEnabled() && !mxEvent.isConsumed(a) && this.isGraphEvent(a) && this.isEnabled()) if (27 == a.keyCode) this.escape(a);
...
mxTooltipHandler.prototype.init = function() {
    null != document.body && (this.div = document.createElement("div"), this.div.className = "mxTooltip", this.div.style.visibility = "hidden", document.body.appendChild(this.div), mxEvent.addGestureListeners(this.div, mxUtils.bind(this,
    function(a) {
        this.hideTooltip()
    })))
};
...
mxTooltipHandler.prototype.mouseMove = function(a, b) {
    if (b.getX() != this.lastX || b.getY() != this.lastY) this.reset(b, !0),
    (this.isHideOnHover() || b.getState() != this.state || b.getSource() != this.node && (!this.stateSource || null != b.getState() && this.stateSource == (b.isSource(b.getState().shape) || !b.isSource(b.getState().text)))) && this.hideTooltip();
    this.lastX = b.getX();
    this.lastY = b.getY()
};
...
mxTooltipHandler.prototype.reset = function(a, b) {
    if (!this.ignoreTouchEvents || mxEvent.isMouseEvent(a.getEvent())) if (this.resetTimer(), b && this.isEnabled() && null != a.getState() && (null == this.div || "hidden" == this.div.style.visibility)) {
        var c = a.getState(),
        d = a.getSource(),
        e = a.getX(),
        f = a.getY(),
...
function mxCellHighlight(a, b, c, d) {
    null != a && (this.graph = a, this.highlightColor = null != b ? b: mxConstants.DEFAULT_VALID_COLOR, this.strokeWidth = null != c ? c: mxConstants.HIGHLIGHT_STROKEWIDTH, this.dashed = null != d ? d: !1, this.repaintHandler = mxUtils.bind(this,
    function() {
        if (null != this.state) {
            var a = this.graph.view.getState(this.state.cell);
            null == a ? this.hide() : (this.state = a, this.repaint())
        }
    }), this.graph.getView().addListener(mxEvent.SCALE, this.repaintHandler), this.graph.getView().addListener(mxEvent.TRANSLATE, this.repaintHandler), this.graph.getView().addListener(mxEvent.SCALE_AND_TRANSLATE, this.repaintHandler), this.graph.getModel().addListener(mxEvent.CHANGE, this.repaintHandler), this.resetHandler = mxUtils.bind(this,
    function() {
        this.hide()
...
mxDefaultToolbar.prototype.init = function(a) {
    null != a && (this.toolbar = new mxToolbar(a), this.toolbar.addListener(mxEvent.SELECT, mxUtils.bind(this,
    function(a, c) {
        var d = c.getProperty("function");
        this.editor.insertFunction = null != d ? mxUtils.bind(this,
        function() {
...
function mxEditor(a) {
    ...
    if (null != document.body) {
        ...
        this.configure(a);
        this.graph.swimlaneIndicatorColorAttribute = this.cycleAttributeName; ! mxClient.IS_LOCAL && null != this.urlInit && (this.session = this.createSession());
        if (null != this.onInit) this.onInit();
        mxClient.IS_IE && mxEvent.addListener(window, "unload", mxUtils.bind(this,
        function() {
            this.destroy()
...
mxEditor.prototype.execute = function(a, b, c) {
    ...
    if (null != d) try {
        ...
        throw mxUtils.error("Cannot execute " + a + ": " + f.message, 280, !0),
        f;
...
mxEditor.prototype.createGraph = function() {
    ...
    a.popupMenuHandler.factoryMethod = mxUtils.bind(this,
    function(a, c, d) {
...
mxEditor.prototype.createLayoutManager = function(a) {
    ...
    b.getLayout = function(b) {
        var e = null,
        f = c.graph.getModel();
        if (null != f.getParent(b)) if (c.layoutSwimlanes && a.isSwimlane(b)) null == c.swimlaneLayout && (c.swimlaneLayout = c.createSwimlaneLayout()),
        e = c.swimlaneLayout;
        else if (c.layoutDiagram && (a.isValidRoot(b) || null == f.getParent(f.getParent(b)))) null == c.diagramLayout && (c.diagramLayout = c.createDiagramLayout()),
        e = c.diagramLayout;
        return e
    };
    return b
...
mxEditor.prototype.installChangeHandler = function(a) {
    var b = mxUtils.bind(this,
    function(b, d) {
        this.setModified(!0); ! 0 == this.validating && a.validateGraph();
...
mxEditor.prototype.installInsertHandler = function(a) {
    ...
    a.addMouseListener({
        mouseDown: function(a, d) {
            if (null != b.insertFunction && !d.isPopupTrigger() && (b.forcedInserting || null == d.getState())) b.graph.clearSelection(),
...
mxEditor.prototype.setStatusContainer = function(a) {
    null == this.status && (this.status = a, this.addListener(mxEvent.SAVE, mxUtils.bind(this,
    function() {
...
mxEditor.prototype.getTitle = function() {
    for (var a = "",
    b = this.graph,
    c = b.getCurrentRoot(); null != c && null != b.getModel().getParent(b.getModel().getParent(c));) b.isValidRoot(c) && (a = " > " + b.convertValueToString(c) + a),
...
mxEditor.prototype.connect = function(a, b, c, d) {
    var e = null;
    mxClient.IS_LOCAL || (e = new mxSession(this.graph.getModel(), a, b, c), e.addListener(mxEvent.RECEIVE, mxUtils.bind(this,
    function(a, b) {
...
mxEditor.prototype.showProperties = function(a) {
    ...
    if (null != a) {
        ...
        c = b.x + 10,
        b = b.y;
        if (null != this.properties && !this.movePropertiesDialog) c = this.properties.getX(),
...
mxEditor.prototype.showHelp = function(a) {
    if (null == this.help) {
        ...
        d = new mxWindow(mxResources.get(this.helpResource) || this.helpResource, b, (a - this.helpWidth) / 2, (c - this.helpHeight) / 3, this.helpWidth, this.helpHeight);
        d.setMaximizable(!0);
        d.setClosable(!0);
        d.destroyOnClose = !1;
        d.setResizable(!0);
...
mxEditor.prototype.addVertex = function(a, b, c, d) {
    ...
    try {
        ...
        null != b && (this.graph.constrainChild(b), this.fireEvent(new mxEventObject(mxEvent.ADD_VERTEX, "vertex", b)))
    } finally {
        e.endUpdate()
    }
...
mxCodec.prototype.decodeCell = function(a, b) {
    ...
    if (null != a && a.nodeType == mxConstants.NODETYPE_ELEMENT) {
        ...
        if (!this.isCellCodec(c)) for (var d = a.firstChild; null != d && !this.isCellCodec(c);) c = mxCodecRegistry.getCodec(d.nodeName),
        d = d.nextSibling;
...
mxObjectCodec.prototype.encodeValue = function(a, b, c, d, e) {
    if (null != d) {
        ...
        f = this.template[c];
        if (null == c || a.encodeDefaults || f != d) c = this.getAttributeName(c),
...
mxObjectCodec.prototype.decodeChild = function(a, b, c) {
    ...
    if (null == d || !this.isExcluded(c, d, b, !1)) {
        ...
        f = null;
        "add" == b.nodeName ? (f = b.getAttribute("value"), null == f && mxObjectCodec.allowEval && (f = mxUtils.eval(mxUtils.getTextContent(b)))) : f = a.decode(b, e);
...
mxCodecRegistry.register(function() {
    ...
    a.beforeDecode = function(a, c, d) {
        if (null != c.firstChild && c.firstChild.nodeType == mxConstants.NODETYPE_ELEMENT) {
            ...
            for (e = d; null != e;) d = e.nextSibling,
            a.decodeCell(e),
            e.parentNode.removeChild(e),
            e = d
        }
        ...
        if (null == g || null != f) {
            ...
            if (null != m) {
                ...
                if (null == g) {
                    ...
                    for (p in f.style) g = f.style[p],
                    "function" == typeof g && "object" == typeof g && (g = mxStyleRegistry.getName(g)),
                    null != g && ("function" != typeof g && "object" != typeof g) && n.setAttribute(p, g);
                    g = f.absolutePoints;
                    ...
                    } else n.setAttribute("x", Math.round(f.x)),
                    n.setAttribute("y", Math.round(f.y)),
                    n.setAttribute("width", Math.round(f.width)),
                    n.setAttribute("height", Math.round(f.height));
                    p = f.absoluteOffset;
                    null != p && (0 != p.x && n.setAttribute("dx", Math.round(p.x)), 0 != p.y && n.setAttribute("dy", Math.round(p.y)))
                }
                for (p = 0; p < k; p++) f = this.encodeCell(a, c, e.getChildAt(d, p)),
                null != f && n.appendChild(f)
            }
        }
        return n
    };
                ...
                for (f = c.firstChild; null != f;) {
                    if (f.nodeType == mxConstants.NODETYPE_ELEMENT) {
                        ...
                        if ("add" == f.nodeName) {
                            ...
                            m = null;
                            null != l && 0 < l.length && mxStylesheetCodec.allowEval ? m = mxUtils.eval(l) : (m = f.getAttribute("value"), mxUtils.isNumeric(m) && (m = parseFloat(m)));
                            null != m && (g[k] = m)
...
var mxDefaultToolbarCodec = mxCodecRegistry.register(function() {
    ...
    a.decode = function(a, c, d) {
        if (null != d) {
            var e = d.editor;
            for (c = c.firstChild; null != c;) {
                if (c.nodeType == mxConstants.NODETYPE_ELEMENT && !this.processInclude(a, c, d)) if ("separator" == c.nodeName) d.addSeparator();
                    ...
                    else if (null != m) var s = mxDefaultToolbarCodec.allowEval ? mxUtils.eval(q) : null,
                    r = d.addMode(f, g, m, k, s);
                    else if (null != n || null != q && 0 < q.length) r = e.templates[n],
                    n = c.getAttribute("style"),
                    null != r && null != n && (r = e.graph.cloneCells([r])[0], r.setStyle(n)),
                    n = null,
                    null != q && (0 < q.length && mxDefaultToolbarCodec.allowEval) && (n = mxUtils.eval(q)),
                    r = d.addPrototype(f, g, r, k, n, p);
                    else if (k = mxUtils.getChildNodes(c), 0 < k.length) if (null == g) {
                        n = d.addActionCombo(f);
                        for (f = 0; f < k.length; f++) p = k[f],
                        "separator" == p.nodeName ? d.addOption(n, "---") : "add" == p.nodeName && (g = p.getAttribute("as"), p = p.getAttribute("action"), d.addActionOption(n, g, p))
                    } else {
                        var t = null,
                        u = d.addPrototype(f, g,
                        function() {
                        ...
                        null, null, p),
                        t = d.addCombo();
                        mxEvent.addListener(t, "change",
                        function() {
                            d.toolbar.selectMode(u,
                            function(a) {
                        ...
                        for (f = 0; f < k.length; f++) p = k[f],
                        "separator" == p.nodeName ? d.addOption(t, "---") : "add" == p.nodeName && (g = p.getAttribute("as"), q = p.getAttribute("template"), d.addOption(t, g, q || n).cellStyle = p.getAttribute("style"))
                    }
    ...
    a.decodeUi = function(a, c, d) {
        for (a = c.firstChild; null != a;) {
            if ("add" == a.nodeName) {
                ...
                g = null;
                if (null != e) g = document.getElementById(e),
                null != g && null != f && (g.style.cssText += ";" + f);
                else {
                    ...
                    g = document.createElement("div");
                    g.style.cssText = f; (new mxWindow(mxResources.get(c) || c, g, e, k, l, m, !1, !0)).setVisible(!0)
                }
