...
<div class="easyui-panel" fit="true">
	<fd:datagrid id="inputsList" checkbox="false" fitColumns="true" pagination="true"
		url="taskDetailController.do?getInputsRelationList&id=${planId}" 
		toolbar="#tagListtb" idField="id" fit="true">
		<fd:dgCol title="{com.glaway.ids.common.lable.name}" field="name" width="120"></fd:dgCol>
		<fd:dgCol title="{com.glaway.ids.pm.project.plan.deliverables.docName}" field="docName" width="120" formatterFunName="addLink"></fd:dgCol>
		<fd:dgCol title="{com.glaway.ids.pm.project.plan.deliverables.orgin}" field="originPath" formatterFunName = "showOrigin" width="120" ></fd:dgCol>
	</fd:datagrid>	
</div>
<script src="webpage/com/glaway/ids/project/plan/planList.js"></script>
	<fd:dialog id="openAndSubmitDialog" width="870px" height="550px" modal="true"
