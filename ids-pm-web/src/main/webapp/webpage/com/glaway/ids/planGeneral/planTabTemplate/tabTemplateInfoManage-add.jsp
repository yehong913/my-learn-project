...
<div data-options="region:'north',collapsible:false" style="height: 175px;margin-top: 16px">
    <fd:form id="addTabTemplateForm">
        <fd:inputText title="页签名称" name="name" id="addTabTemplate_name" required="true" />
        <fd:combobox  title="页签类型" name="tabType" id="addTabTemplate_tabType" textField="text" editable="false" valueField="value"
                      data="1_工作内容,2_职责权限,3_资源,4_风险控制,5_过程管理,6_过程结果" value="工作内容"></fd:combobox>
        <fd:combobox  title="页面显示方式" name="displayUsage" id="addTabTemplate_displayUsage" textField="text"
                      editable="false" valueField="value" data="1_对象选择,2_外部URL" value="对象选择" onChange="changeDisplayUsage"></fd:combobox>
        <fd:inputTextArea title="备注" name="remark" id="addTabTemplate_remark" />
...
<div data-options="region:'center'">
    <div style="display: none" id="urlDivShow">
        <fd:inputText title="外部URL" id="addTabTemplate_externalURL_copy" required="true" maxLength="200"/>
    </div>
    <div id="dataSourceDiv">
        ...
        <fd:panel id="one" border="false" title="对象数据编辑" fit="false" collapsed="false" width="100%" height="200px" >
            ...
            <fd:datagrid toolbar="#addDataSourceObjectDiv" pagination="false" checkOnSelect="true"
        ...
        <fd:panel id="two" border="false" title="视图控件编辑"  fit="false"  collapsed="false" width="100%" height="200px" >
            ...
            <fd:datagrid toolbar="#addObjectPropertyDiv" pagination="false" onDblClickRow="doObjectPropertyEdit" onClickFunName="editObjectPropertyOver"
                         idField="id" id="addObjectPropertyList" fit="true" fitColumns="true" width="100%">
                <fd:dgCol title="主键ID" field="id" hidden="true" sortable="false"/>
...
<script type="text/javascript">
    ...
    function tabTemplateInfoSubmit(avaliable) {
        ...
        $.ajax({
            url : 'tabTemplateController.do?doSave',
            type : 'post',
            data : {
                id: tabId,
                avaliable:avaliable,
            ...
            top.Alert.confirm('<spring:message code="com.glaway.ids.common.confirmBatchDel"/>', function(r) {
                if (r) {
                    for(var i = (rows.length-1); i >=0;i-- ){
                        ...
                        //后台执行删除数据源对象
                        $.ajax({
                            url : 'dataSourceObjectController.do?doDelete',
                            type : 'post',
                            data : {
                                id: id
                            },
    ...
    function modifyOPI(dataSourceId, objectPath, propertyValue, propertyName) {
    ...
    function formSubmit() {
        ...
        var displayUsageValue = $("#addTabTemplate_displayUsage").combobox('getValue');
        //对象选择需要填写数据
        if (displayUsageValue=="1"||displayUsageValue=="对象选择"){
            if (dataSourceObjectArray.length>0&&objectPropertyArray.length>0) {
                ...
                $.ajax({
                    type : 'post',
                    url : 'dataSourceObjectController.do?saveAllInfo',
                    data : {
