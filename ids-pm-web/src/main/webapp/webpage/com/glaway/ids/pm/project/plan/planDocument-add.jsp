...
<div class="easyui-layout" fit="true">
	...
	<div id="documentListtb">
		<fd:searchform id="deliverablesSearchForm" onClickSearchBtn="searchDocument()" onClickResetBtn="tagSearchReset()">
	...
	<fd:datagrid checkbox="true" fitColumns="true"  checked="true" checkOnSelect="true" idField="id" toolbar="#documentListtb" id="deliverablesList"  pagination="true"
		url="deliverablesInfoController.do?datagridlist&useObjectId=${deliverablesInfo_.useObjectId}&useObjectType=${deliverablesInfo_.useObjectType}" fit="true">
		<fd:dgCol title="{com.glaway.ids.common.lable.code}"  field="no" sortable="false"/>
		<fd:dgCol title="{com.glaway.ids.common.lable.name}"  field="name" sortable="false"/>
		<fd:dgCol title="{com.glaway.ids.common.lable.remark}"  field="remark" sortable="false"/>
		<fd:dgCol title="{com.glaway.ids.common.lable.status}"  field="stopFlag" sortable="false"/>
	</fd:datagrid>
<%-- 	<fd:lazydatagrid id="deliverablesList" idField="id" url="deliverablesInfoController.do?datagridlist&useObjectId=${deliverablesInfo_.useObjectId}&useObjectType=${deliverablesInfo_.useObjectType}" 
...
function addDocument() {
    ...
    if (rows.length > 0) {
		...
		// "请选择需要下达的数据"
		tip('<spring:message code="com.glaway.ids.pm.project.plan.selectOne"/>');
	}
}
...
function searchDocument() {
    ...
    var datas = {
 	...
 	$.ajax({
		type : 'POST',
		url : 'deliverablesInfoController.do?datagridSearchlist',
		async : false,
		data : datas,
		success : function(data) {
