...
<div class="easyui-layout" fit="true">
	...
	<fd:datagrid checkbox="true"  fitColumns="true"  checked="true" checkOnSelect="true" idField="id"  id="deliverablesList"  pagination="false" height="250px"
		url="planChangeController.do?datagridInheritlist" fit="false">
...
function add(){
	    ...
	    if (rows.length > 0) {
			...
			$.ajax({
				url : 'planChangeController.do?doAddTempInheritlist',
				async : false,
				cache : false,
				type : 'post',
				data : datas,
				...
				success : function(data) {
					...
					var planListSearch = win.TC003.loadData();
					$.fn.lhgdialog("closeSelect");
				}
			});
		} else {
