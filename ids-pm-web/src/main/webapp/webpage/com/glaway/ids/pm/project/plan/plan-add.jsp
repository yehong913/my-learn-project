...
<div id="plan" border="false" class="easyui-panel div-msg" fit="true">
	...
	<div class="easyui-panel" fit="true" id="zhezhao">
		...
		<fd:combobox id="planLevel" textField="name" title="{com.glaway.ids.pm.project.plan.planLevel}" selectedValue="${planLevelId}"
...
<fd:dialog id="resourceDialog" width="900px" height="800px" modal="true" title="资源图" maxFun="addInheritDialogtrue">
</fd:dialog>
